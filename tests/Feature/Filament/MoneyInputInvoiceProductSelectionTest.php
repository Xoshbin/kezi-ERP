...
class MoneyInputInvoiceProductSelectionTest extends TestCase
{
    ...
    private \Jmeryar\Foundation\Models\Currency $currency;

    private \Jmeryar\Foundation\Models\Partner $customer;

    private \Jmeryar\Product\Models\Product $product;

    private \Jmeryar\Accounting\Models\Account $incomeAccount;
    ...
    protected function setUp(): void
    {
        ...
        $this->currency = \Jmeryar\Foundation\Models\Currency::factory()->create(['code' => 'USD']);

        $this->company->update(['currency_id' => $this->currency->id]);

        $this->customer = \Jmeryar\Foundation\Models\Partner::factory()->customer()->create([
            'company_id' => $this->company->id,
        ]);

        $this->incomeAccount = \Jmeryar\Accounting\Models\Account::factory()->create([
            'company_id' => $this->company->id,
            'type' => 'income',
        ]);

        // Create a product with a specific Money unit price
        $this->product = \Jmeryar\Product\Models\Product::factory()->create([
            'company_id' => $this->company->id,
    ...
    public function it_handles_products_with_different_price_formats_in_invoice(): void
    {
        ...
        $integerProduct = \Jmeryar\Product\Models\Product::factory()->create([
            'company_id' => $this->company->id,
        ...
        $decimalProduct = \Jmeryar\Product\Models\Product::factory()->create([
            'company_id' => $this->company->id,
    ...
    public function it_handles_products_with_null_unit_price_in_invoice(): void
    {
        ...
        $nullPriceProduct = \Jmeryar\Product\Models\Product::factory()->create([
            'company_id' => $this->company->id,
    ...
    public function it_populates_description_from_product_description_not_name(): void
    {
        ...
        $productWithDescription = \Jmeryar\Product\Models\Product::factory()->create([
            'company_id' => $this->company->id,
            'name' => 'Product Name',
