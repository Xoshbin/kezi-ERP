...
class FilamentInlineCreate
{
    ...
    public static function partner(array $overrides = []): \Jmeryar\Foundation\Models\Partner
    {
        $defaults = [
        ...
        return \Jmeryar\Foundation\Models\Partner::factory()->create(array_merge($defaults, $overrides));
    }

    public static function currency(array $overrides = []): \Jmeryar\Foundation\Models\Currency
    {
        $defaults = [
            'code' => 'EUR',
            'name' => ['en' => 'Euro'],
        ...
        return \Jmeryar\Foundation\Models\Currency::query()->firstOrCreate(
    ...
    public static function account(array $overrides = []): \Jmeryar\Accounting\Models\Account
    {
        $company = $overrides['company'] ?? auth()->user()?->companies()->first();
        ...
        return \Jmeryar\Accounting\Models\Account::factory()->for($company)->create($data);
    }
}
