...
class JmeryarPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverResources(in: base_path('Modules/Manufacturing/app/Filament/Clusters/Manufacturing/Resources'), for: 'Modules\\Manufacturing\\Filament\\Clusters\\Manufacturing\\Resources')
            ->discoverWidgets(in: base_path('Modules/Manufacturing/app/Filament/Clusters/Manufacturing/Widgets'), for: 'Modules\\Manufacturing\\Filament\\Clusters\\Manufacturing\\Widgets')
