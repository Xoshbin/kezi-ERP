...
use App\Filament\Resources\Journals\RelationManagers\JournalEntriesRelationManager;
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                Select::make('default_debit_account_id')
                ...
                Select::make('default_credit_account_id')
