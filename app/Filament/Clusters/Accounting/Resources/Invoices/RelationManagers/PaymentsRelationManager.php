...
class PaymentsRelationManager extends RelationManager
{
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                Section::make(__('invoice.payments_relation_manager.payment_details'))
                    ->schema([
                ...
                Section::make(__('invoice.payments_relation_manager.application_details'))
                    ->schema([
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->mutateDataUsing(function (array $data): array {
                        $owner = $this->getOwnerRecord();
                        $data['paid_to_from_partner_id'] = $owner instanceof \App\Models\Invoice ? $owner->customer_id : null;
