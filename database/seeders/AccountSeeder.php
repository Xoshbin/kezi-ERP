...
class AccountSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $accounts = [
            ...
            ['code' => '130102', 'name' => ['en' => 'Inventory Asset (IQD)', 'ckb' => 'کۆگای کاڵا (دینار)', 'ar' => 'أصل المخزون (دينار عراقي)'], 'type' => AccountType::CurrentAssets],
            ...
            ['code' => '210102', 'name' => ['en' => 'Accounts Payable (IQD)', 'ckb' => 'حسابە دراوەکان (دینار)', 'ar' => 'حسابات دائنة (دينار عراقي)'], 'type' => AccountType::Payable],
            ...
            ['code' => '210202', 'name' => ['en' => 'Stock Input Account (IQD)', 'ckb' => 'حسابی هاتنی کۆگا (دینار)', 'ar' => 'حساب إدخال المخزون (دينار عراقي)'], 'type' => AccountType::CurrentLiabilities],
            ...
            ['code' => '410102', 'name' => ['en' => 'Sales Revenue (IQD)', 'ckb' => 'داهاتی فرۆشتن (دینار)', 'ar' => 'إيرادات المبيعات (دينار عراقي)'], 'type' => AccountType::Income],
            ...
            ['code' => '510202', 'name' => ['en' => 'Inventory Adjustments (IQD)', 'ckb' => 'ڕێکخستنی کۆگا (دینار)', 'ar' => 'تعديلات المخزون (دينار عراقي)'], 'type' => AccountType::Expense],
