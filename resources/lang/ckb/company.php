...
return [
    ...
    'default_purchase_journal' => 'رۆژنامچەی کڕینی بنەڕەت',
    ...
    'default_sales_journal' => 'رۆژنامچەی فرۆشتنی بنەڕەت',
    'default_depreciation_journal' => 'رۆژنامچەی بەکارهێنانی بنەڕەت',
