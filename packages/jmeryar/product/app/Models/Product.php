...
use Jmeryar\Inventory\Models\ReorderingRule;
 ...
 * @property \Jmeryar\Product\Enums\Products\ProductType $type
 ...
 * @property \Jmeryar\Inventory\Enums\Inventory\ValuationMethod $inventory_valuation_method
 ...
 * @property \Jmeryar\Inventory\Enums\Inventory\TrackingType $tracking_type
 * @property float $weight
 * @property float $volume
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \Jmeryar\Accounting\Models\Tax> $purchaseTaxes
 ...
 * @method static \Jmeryar\Product\Database\Factories\ProductFactory factory($count = null, $state = [])
 ...
 * @mixin Eloquent
 */
#[ObservedBy([\Jmeryar\Product\Observers\ProductObserver::class])]
class Product extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Product\Database\Factories\ProductFactory
    {
        return \Jmeryar\Product\Database\Factories\ProductFactory::new();
    }
    ...
    protected $casts = [
        'unit_price' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'average_cost' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'is_active' => 'boolean',
        'inventory_valuation_method' => ValuationMethod::class,
        'created_at' => 'datetime',
        'updated_at' => 'datetime',
        'deleted_at' => 'datetime',
        'type' => \Jmeryar\Product\Enums\Products\ProductType::class,
        'tracking_type' => \Jmeryar\Inventory\Enums\Inventory\TrackingType::class,
        'weight' => 'float',
        'volume' => 'float',
        'is_template' => 'boolean',
    ...
    protected static function booted(): void
    {
        static::saving(function (Product $product) {
            if ($product->type === \Jmeryar\Product\Enums\Products\ProductType::Storable && empty($product->default_inventory_account_id)) {
     ...
     *
     * @return HasMany<\Jmeryar\Manufacturing\Models\BillOfMaterial, static>
     */
    public function billsOfMaterials(): HasMany
    {
        return $this->hasMany(\Jmeryar\Manufacturing\Models\BillOfMaterial::class);
    }

    /**
     * Get manufacturing orders for this product
     *
     * @return HasMany<\Jmeryar\Manufacturing\Models\ManufacturingOrder, static>
     */
    public function manufacturingOrders(): HasMany
    {
        return $this->hasMany(\Jmeryar\Manufacturing\Models\ManufacturingOrder::class);
    }
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany<\Jmeryar\Accounting\Models\Tax, static>
     */
    public function purchaseTaxes(): \Illuminate\Database\Eloquent\Relations\BelongsToMany
    {
        return $this->belongsToMany(\Jmeryar\Accounting\Models\Tax::class, 'product_purchase_tax');
    }
}
