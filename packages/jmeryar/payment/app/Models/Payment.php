...
use Jmeryar\Payment\Observers\PaymentObserver;
 ...
 *
 * @method static \Jmeryar\Payment\Database\Factories\PaymentFactory factory($count = null, $state = [])
 ...
 * @mixin Eloquent
 */
#[ObservedBy([\Jmeryar\Foundation\Observers\AuditLogObserver::class, PaymentObserver::class])]
class Payment extends Model
{
    ...
    protected $casts = [
        ...
        'amount' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Payment amount in payment currency
        'amount_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class, // Payment amount in company base currency
     ...
     *
     * @return HasMany<\Jmeryar\Accounting\Models\WithholdingTaxEntry, static>
     */
    public function withholdingTaxEntries(): HasMany
    {
        return $this->hasMany(\Jmeryar\Accounting\Models\WithholdingTaxEntry::class);
    }
    ...
    protected static function newFactory(): \Jmeryar\Payment\Database\Factories\PaymentFactory
    {
        return \Jmeryar\Payment\Database\Factories\PaymentFactory::new();
    }
}
