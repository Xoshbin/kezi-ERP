...
class PettyCashFund extends Model
{
    ...
    {
        return \Jmeryar\Payment\Database\Factories\PettyCash\PettyCashFundFactory::new();
    }
    ...
    protected $casts = [
        'imprest_amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'current_balance' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
