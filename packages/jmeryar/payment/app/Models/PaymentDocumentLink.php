...
class PaymentDocumentLink extends Model
{
     ...
     */
    protected $casts = [
        'amount_applied' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Amount in payment currency
    ...
    protected static function newFactory(): \Jmeryar\Payment\Database\Factories\PaymentDocumentLinkFactory
    {
        return \Jmeryar\Payment\Database\Factories\PaymentDocumentLinkFactory::new();
    }
}
