...
namespace Jmeryar\Payment\Tests\Feature\Traits;
...
test('HasPaymentState trait works correctly with Invoice model', function () {
    ...
    // Test initial state
    expect($invoice->paymentState)->toBe(\Jmeryar\Foundation\Enums\Shared\PaymentState::NotPaid)
    ...
    expect($invoice->paymentState)->toBe(\Jmeryar\Foundation\Enums\Shared\PaymentState::PartiallyPaid)
...
test('HasPaymentState trait works correctly with VendorBill model', function () {
    ...
    // Test initial state
    expect($vendorBill->paymentState)->toBe(\Jmeryar\Foundation\Enums\Shared\PaymentState::NotPaid)
    ...
    expect($vendorBill->paymentState)->toBe(\Jmeryar\Foundation\Enums\Shared\PaymentState::Paid)
...
test('HasPaymentState trait handles overpayment correctly', function () {
    ...
    expect($invoice->paymentState)->toBe(\Jmeryar\Foundation\Enums\Shared\PaymentState::Paid)
...
test('HasPaymentState trait uses efficient queries', function () {
    ...
    expect($paymentState)->toBe(\Jmeryar\Foundation\Enums\Shared\PaymentState::NotPaid)
    ...
    expect($paymentState2)->toBe(\Jmeryar\Foundation\Enums\Shared\PaymentState::NotPaid);
});
