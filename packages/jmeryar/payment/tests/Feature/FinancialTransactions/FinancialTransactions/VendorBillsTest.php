...
test('it correctly computes its payment state via a many-to-many relationship', function (Money $paidAmount, Money $totalAmount, \Jmeryar\Foundation\Enums\Shared\PaymentState $expectedState) {
    ...
    'not paid' => [Money::of(0, 'IQD'), Money::of(150000, 'IQD'), \Jmeryar\Foundation\Enums\Shared\PaymentState::NotPaid],
    'partially paid' => [Money::of(75000, 'IQD'), Money::of(150000, 'IQD'), \Jmeryar\Foundation\Enums\Shared\PaymentState::PartiallyPaid],
    'fully paid' => [Money::of(150000, 'IQD'), Money::of(150000, 'IQD'), \Jmeryar\Foundation\Enums\Shared\PaymentState::Paid],
    'overpaid' => [Money::of(160000, 'IQD'), Money::of(150000, 'IQD'), \Jmeryar\Foundation\Enums\Shared\PaymentState::Paid],
]);
