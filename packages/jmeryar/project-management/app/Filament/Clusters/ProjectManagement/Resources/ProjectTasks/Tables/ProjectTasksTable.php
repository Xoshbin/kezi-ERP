...
namespace Jmeryar\ProjectManagement\Filament\Clusters\ProjectManagement\Resources\ProjectTasks\Tables;
        ...
        return $table
            ...
            ->filters([
                ...
                SelectFilter::make('status')
                    ->options(\Jmeryar\ProjectManagement\Enums\TaskStatus::class),
                TrashedFilter::make(),
            ])
            ->recordActions([
                EditAction::make(),
