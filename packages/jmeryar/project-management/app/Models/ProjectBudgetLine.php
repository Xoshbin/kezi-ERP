 ...
 */
#[ObservedBy([\Jmeryar\Foundation\Observers\AuditLogObserver::class, \Jmeryar\ProjectManagement\Observers\ProjectBudgetLineObserver::class])]
class ProjectBudgetLine extends Model
{
    ...
    protected $casts = [
        ...
        'actual_amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
    ];
    ...
    {
        return \Jmeryar\ProjectManagement\Database\Factories\ProjectBudgetLineFactory::new();
    }
}
