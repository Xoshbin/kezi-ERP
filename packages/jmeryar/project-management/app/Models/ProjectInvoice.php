...
class ProjectInvoice extends Model
{
    ...
    protected $casts = [
        ...
        'period_start' => 'date',
        'period_end' => 'date',
        'labor_amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'expense_amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'total_amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'created_at' => 'datetime',
        'updated_at' => 'datetime',
    ];
    ...
    {
        return \Jmeryar\ProjectManagement\Database\Factories\ProjectInvoiceFactory::new();
    }
}
