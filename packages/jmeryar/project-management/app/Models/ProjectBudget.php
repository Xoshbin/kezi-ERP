...
class ProjectBudget extends Model
{
    ...
    protected $casts = [
        ...
        'created_at' => 'datetime',
        'updated_at' => 'datetime',
        'total_budget' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'total_actual' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
    ];
    ...
    {
        return \Jmeryar\ProjectManagement\Database\Factories\ProjectBudgetFactory::new();
    }
}
