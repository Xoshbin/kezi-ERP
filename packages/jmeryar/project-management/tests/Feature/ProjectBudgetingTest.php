...
use Jmeryar\ProjectManagement\Services\ProjectBudgetService;
...
it('creates project budget with lines', function () {
    $account1 = Account::factory()->create(['company_id' => $this->company->id, 'type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::Expense]);
    $account2 = Account::factory()->create(['company_id' => $this->company->id, 'type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::Expense]);
