...
use Jmeryar\Purchase\Actions\Purchases\CreateDebitNoteAction;
use Jmeryar\Purchase\DataTransferObjects\Purchases\CreateDebitNoteDTO;
use Jmeryar\Purchase\DataTransferObjects\Purchases\CreateDebitNoteLineDTO;
...
beforeEach(function () {
    ...
    // Vendor
    $this->vendor = \Jmeryar\Foundation\Models\Partner::factory()->for($this->company)->create(['type' => 'vendor']);
