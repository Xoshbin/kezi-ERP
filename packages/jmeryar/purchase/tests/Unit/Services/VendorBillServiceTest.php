...
namespace Jmeryar\Purchase\tests\Unit\Services;
...
use Jmeryar\Accounting\Services\BudgetControlService;
...
use Jmeryar\Purchase\Services\ShippingCostAllocationService;
...
describe('validateShippingCosts', function () {
    it('delegates validation to ShippingCostAllocationService', function () {
        $bill = VendorBill::factory()->create();
        $result = new \Jmeryar\Purchase\DataTransferObjects\Purchases\ShippingCostValidationResult(
            true,
            [],
            [],
            Money::of(0, 'USD')
