...
namespace Jmeryar\Purchase\Models;
...
use Jmeryar\Payment\Enums\PaymentInstallments\InstallmentStatus;
use Jmeryar\Payment\Models\Payment;
use Jmeryar\Payment\Models\PaymentDocumentLink;
use Jmeryar\Payment\Models\PaymentInstallment;
use Jmeryar\Purchase\Database\Factories\VendorBillFactory;
use Jmeryar\Purchase\Enums\Purchases\ThreeWayMatchStatus;
use Jmeryar\Purchase\Enums\Purchases\VendorBillStatus;
use Jmeryar\Purchase\Observers\VendorBillObserver;
 ...
 *
 * @method static \Jmeryar\Purchase\Database\Factories\VendorBillFactory factory($count = null, $state = [])
 ...
 * @mixin Eloquent
 */
#[ObservedBy([\Jmeryar\Foundation\Observers\AuditLogObserver::class, VendorBillObserver::class])]
class VendorBill extends Model
{
    use HasFactory;
    use \Jmeryar\Foundation\Traits\HasPaymentState;

    protected static function newFactory(): VendorBillFactory
    {
        return \Jmeryar\Purchase\Database\Factories\VendorBillFactory::new();
    }
    ...
    protected $casts = [
        ...
        'total_amount' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,  // Document currency amounts
        'total_tax' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,  // Document currency amounts
        'total_amount_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,  // Company base currency amounts
        'total_tax_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,  // Company base currency amounts
