...
use Jmeryar\Purchase\Database\Factories\VendorBillLineFactory;
use Jmeryar\Purchase\Observers\VendorBillLineObserver;
...
class VendorBillLine extends Model
{
    ...
    {
        return \Jmeryar\Purchase\Database\Factories\VendorBillLineFactory::new();
    }
    ...
    protected $casts = [
        ...
        'unit_price' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Document currency amounts
        'unit_price_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
        ...
        'total_line_tax' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Document currency amounts
        'total_line_tax_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
