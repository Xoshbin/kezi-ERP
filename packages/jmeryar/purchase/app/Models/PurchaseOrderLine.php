...
use Jmeryar\Foundation\Enums\ShippingCostType;
...
class PurchaseOrderLine extends Model
{
    ...
    protected $casts = [
        ...
        'unit_price' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'shipping_cost_type' => ShippingCostType::class,
        'subtotal' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'total_line_tax' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'total' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'unit_price_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'subtotal_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'total_line_tax_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'total_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
    ...
    protected static function newFactory(): \Jmeryar\Purchase\Database\Factories\PurchaseOrderLineFactory
    {
        return \Jmeryar\Purchase\Database\Factories\PurchaseOrderLineFactory::new();
    }
}
