...
class CreateVendorBillAction
{
    public function __construct(
        ...
        protected \Jmeryar\Accounting\Services\Accounting\FiscalPositionService $fiscalPositionService,
    ) {}
    ...
    public function execute(CreateVendorBillDTO $createVendorBillDTO): VendorBill
    {
        ...
        return DB::transaction(function () use ($createVendorBillDTO) {
            ...
            if (! $fiscalPositionId) {
                $vendor = \Jmeryar\Foundation\Models\Partner::findOrFail($createVendorBillDTO->vendor_id);
