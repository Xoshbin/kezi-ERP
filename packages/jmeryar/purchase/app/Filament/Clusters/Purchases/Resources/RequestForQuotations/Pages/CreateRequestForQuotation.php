...
use Jmeryar\Purchase\DataTransferObjects\Purchases\CreateRFQLineDTO;
    ...
    protected function handleRecordCreation(array $data): \Illuminate\Database\Eloquent\Model
    {
        ...
        if (isset($data['lines'])) {
            ...
            foreach ($data['lines'] as $lineData) {
                ...
                // For valid DTO usage:
                $product = \Jmeryar\Product\Models\Product::find($lineData['product_id']);
        ...
        $currency = \Jmeryar\Foundation\Models\Currency::find($currencyId);
