...
namespace Jmeryar\Purchase\Filament\Clusters\Purchases\Resources\RequestForQuotations\Schemas;
                ...
                \Filament\Schemas\Components\Section::make(__('purchase::request_for_quotation.sections.general'))
                    ->schema([
                        Forms\Components\Select::make('vendor_id')
                            ...
                            ->options(fn () => Partner::query()->whereIn('type', [\Jmeryar\Foundation\Enums\Partners\PartnerType::Vendor, \Jmeryar\Foundation\Enums\Partners\PartnerType::Both])->pluck('name', 'id'))
                            ->searchable()
                            ->required()
                            ->columnSpan(1),
