...
namespace Jmeryar\Purchase\Filament\Clusters\Purchases\Resources\PurchaseOrders\Schemas;
            ...
            ->components([
                                    ...
                                    ->afterStateUpdated(function (callable $set, callable $get, $state) {
                                        ...
                                        if ($currency && $baseCurrency) {
                                            if ($currency->id === $baseCurrency->id) {
                                                ...
                                                $service = app(\Jmeryar\Foundation\Services\CurrencyConverterService::class);
                    ...
                    ->schema([
                        Repeater::make('lines')
                            ...
                            ->schema([
                                ...
                                \Jmeryar\Foundation\Filament\Forms\Components\MoneyInput::make('unit_price')
                ...
                Section::make(__('purchase::purchase_orders.sections.totals'))
                    ->schema([
                        Grid::make(2)
                            ->schema([
                                \Jmeryar\Foundation\Filament\Forms\Components\MoneyInput::make('total_tax')
                                    ->label(__('purchase::purchase_orders.fields.total_tax'))
                                    ->currencyField('currency_id')
                                    ->disabled()
                                    ->dehydrated(false),

                                \Jmeryar\Foundation\Filament\Forms\Components\MoneyInput::make('total_amount')
