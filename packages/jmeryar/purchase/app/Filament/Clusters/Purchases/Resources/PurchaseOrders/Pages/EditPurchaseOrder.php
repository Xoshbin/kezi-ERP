...
use Jmeryar\Purchase\Actions\Purchases\UpdatePurchaseOrderAction;
use Jmeryar\Purchase\DataTransferObjects\Purchases\CreateVendorBillFromPurchaseOrderDTO;
use Jmeryar\Purchase\DataTransferObjects\Purchases\PurchaseOrderLineDTO;
use Jmeryar\Purchase\DataTransferObjects\Purchases\UpdatePurchaseOrderDTO;
            ...
            Action::make('create_bill')
                ...
                ->action(function () {
                    try {
                        ...
                        $billReference = app(\Jmeryar\Foundation\Services\SequenceService::class)->getNextVendorBillNumber(
                            $this->record->company,
                            Carbon::today()
                        );
