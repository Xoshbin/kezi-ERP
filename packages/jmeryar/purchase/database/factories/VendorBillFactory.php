...
{
    protected $model = \Jmeryar\Purchase\Models\VendorBill::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'total_amount' => function (array $attributes) {
                $currencyCode = \Jmeryar\Foundation\Models\Currency::find($attributes['currency_id'])->code;
    ...
    {
        return $this->afterCreating(function (\Jmeryar\Purchase\Models\VendorBill $vendorBill) use ($count) {
