    ...
    <div class="mb-6 bg-white shadow-sm rounded-lg p-6">
        ...
        <dl class="flex flex-row justify-between w-full space-x-8">
            ...
            <div class="flex flex-col flex-1 items-start">
                ...
                <dd class="mt-1 text-sm text-gray-900">{{ $bankStatement->starting_balance ? \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($bankStatement->starting_balance) : '0.000' }}</dd>
            </div>
            <div class="flex flex-col flex-1 items-start">
                <dt class="text-sm font-medium text-gray-500">{{ __('accounting::bank_statement.ending_balance') }}</dt>
                <dd class="mt-1 text-sm text-gray-900">{{ $bankStatement->ending_balance ? \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($bankStatement->ending_balance) : '0.000' }}</dd>
            </div>
        </dl>
    </div>
