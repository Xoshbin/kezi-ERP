            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                <div class="mb-6">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
                        {{ __('accounting::reports.consolidated_profit_and_loss') }}
                    </h2>
                ...
                <div class="mb-8">
                    ...
                    @if(count($reportData['incomeLines']) > 0)
                        <div class="space-y-2">
                            @foreach($reportData['incomeLines'] as $line)
        ...
        @else
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 text-center">
                <div class="text-gray-400 dark:text-gray-500 mb-4">
                    <x-heroicon-o-chart-bar class="mx-auto h-12 w-12" />
                </div>
