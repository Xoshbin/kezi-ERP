...
namespace Jmeryar\Accounting\Filament\Pages;

use App\Models\Company;
use Filament\Actions\Action;
use Filament\Pages\Page;
use Jmeryar\Accounting\Filament\Clusters\Accounting\AccountingCluster;
use Jmeryar\Accounting\Services\Reports\TaxReportService;
...
class TaxReports extends Page
{
    ...
    {
        return [
            \Jmeryar\Accounting\Services\Reports\Generators\IraqVATReturnGenerator::class => __('accounting::reports.iraq_vat_return'),
        ];
    }
