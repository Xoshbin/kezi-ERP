...
class CashFlowWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make(__('accounting::dashboard.cash_flow.overdue_receivables'), \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($overdueReceivables))
            ...
            Stat::make(__('accounting::dashboard.cash_flow.overdue_payables'), \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($overduePayables))
            ...
            Stat::make(__('accounting::dashboard.cash_flow.forecast_near_term'), \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($netCashFlowSoon))
            ...
            Stat::make(__('accounting::dashboard.cash_flow.forecast_30_days'), \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($netCashFlow30Days))
