...
class ViewPartnerLedger extends Page
{
    ...
    {
        return [
            \Jmeryar\Foundation\Filament\Actions\DocsAction::make('partner-ledger-report'),
    ...
    public function generateReport(): void
    {
        ...
        $this->reportData = [
            ...
            'openingBalance' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->openingBalance),
            'openingBalanceAmount' => $report->openingBalance->getAmount()->toFloat(),
            'closingBalance' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->closingBalance),
