...
class ViewBalanceSheet extends Page
{
    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            \Jmeryar\Foundation\Filament\Actions\DocsAction::make('balance-sheet-report'),
        ];
    }
    ...
    public function generateReport(): void
    {
        ...
        $service = app(\Jmeryar\Accounting\Services\Reports\BalanceSheetService::class);
        ...
        $this->reportData = [
            'assetLines' => $report->assetLines->map(fn ($line) => [
                ...
                'balance' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($line->balance),
            ...
            'totalAssets' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->totalAssets),
            'totalLiabilities' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->totalLiabilities),
            'retainedEarnings' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->retainedEarnings),
            'currentYearEarnings' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->currentYearEarnings),
            ...
            'totalEquity' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->totalEquity),
            'totalLiabilitiesAndEquity' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->totalLiabilitiesAndEquity),
        ];
