...
class ViewProfitAndLoss extends Page
{
    ...
    {
        return [
            \Jmeryar\Foundation\Filament\Actions\DocsAction::make('profit-loss-report'),
    ...
    public function generateReport(): void
    {
        ...
        $this->reportData = [
            ...
            'totalRevenue' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->totalRevenue),
            'totalExpenses' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->totalExpenses),
            'netIncome' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->netIncome),
