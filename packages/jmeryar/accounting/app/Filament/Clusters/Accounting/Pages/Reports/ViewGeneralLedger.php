...
class ViewGeneralLedger extends Page
{
    ...
    public function generateReport(): void
    {
        ...
        $service = app(\Jmeryar\Accounting\Services\Reports\GeneralLedgerService::class);
        ...
        $this->reportData = [
            'accounts' => $report->accounts->map(fn ($account) => [
                ...
                'openingBalance' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($account->openingBalance),
                'openingBalanceAmount' => $account->openingBalance->getAmount()->toFloat(),
                'closingBalance' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($account->closingBalance),
                ...
                'transactionLines' => $account->transactionLines->map(fn ($line) => [
                    ...
                    'debit' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($line->debit),
                    'debitAmount' => $line->debit->getAmount()->toFloat(),
                    'credit' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($line->credit),
