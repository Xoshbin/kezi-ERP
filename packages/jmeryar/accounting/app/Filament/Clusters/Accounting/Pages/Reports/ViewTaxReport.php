...
class ViewTaxReport extends Page
{
    ...
    {
        return [
            \Jmeryar\Foundation\Filament\Actions\DocsAction::make('tax-report'),
        ...
        $this->reportData = [
            'outputTaxLines' => $report->outputTaxLines->map(function ($line) {
                return [
                    ...
                    'netAmount' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($line->netAmount),
                    'taxAmount' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($line->taxAmount),
            ...
            'totalOutputTax' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->totalOutputTax),
            'totalInputTax' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->totalInputTax),
            'netTaxPayable' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($report->netTaxPayable),
