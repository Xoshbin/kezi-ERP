            ...
            ->components([
                Section::make(__('accounting::bill.adjustment_documents_relation_manager.document_details'))
                    ->schema([
                        ...
                        \Jmeryar\Foundation\Filament\Forms\Components\MoneyInput::make('subtotal')
            ...
            ->headerActions([
                CreateAction::make()
                    ...
                    ->using(function (array $data, string $model): Model {
                        ...
                        $account = \Jmeryar\Accounting\Models\Account::where('code', 'like', '5%')->first(); // Expense account

                        $lineDto = new \Jmeryar\Inventory\DataTransferObjects\Adjustments\CreateAdjustmentDocumentLineDTO(
                        ...
                        $dto = new \Jmeryar\Inventory\DataTransferObjects\Adjustments\CreateAdjustmentDocumentDTO(
                            company_id: (int) \Filament\Facades\Filament::getTenant()->id,
                            type: \Jmeryar\Inventory\Enums\Adjustments\AdjustmentDocumentType::from($data['type']),
                            date: $data['date'],
                        ...
                        return app(\Jmeryar\Inventory\Actions\Adjustments\CreateAdjustmentDocumentAction::class)->execute($dto);
                    }),
            ])
            ->recordActions([
                ViewAction::make(),
