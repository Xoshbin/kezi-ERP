...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Partners;
...
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Partners\RelationManagers\InvoicesRelationManager;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Partners\RelationManagers\PaymentsRelationManager;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Partners\RelationManagers\UnreconciledEntriesRelationManager;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Partners\RelationManagers\VendorBillsRelationManager;
                        ...
                        Grid::make(3)
                            ->schema([
                                Select::make('type')
                                    ...
                                    ->searchable()
                                    ->options(
                                        collect(\Jmeryar\Foundation\Enums\Partners\PartnerType::cases())
                                            ->mapWithKeys(fn (\Jmeryar\Foundation\Enums\Partners\PartnerType $type) => [$type->value => $type->label()])
                                    )
                                ...
                                TranslatableSelect::forModel('receivable_account_id', Account::class)
                                    ...
                                    ->createOptionForm([
                                        ...
                                        Select::make('type')
                                            ...
                                            ->options([\Jmeryar\Accounting\Enums\Accounting\AccountType::Receivable->value => \Jmeryar\Accounting\Enums\Accounting\AccountType::Receivable->label()])
                                            ->default(\Jmeryar\Accounting\Enums\Accounting\AccountType::Receivable->value)
                                            ->required(),
                                    ])
                                ...
                                TranslatableSelect::forModel('payable_account_id', Account::class)
                                    ...
                                    ->createOptionForm([
                                        ...
                                        Select::make('type')
                                            ->label(__('accounting::account.type'))
                                            ->searchable()
                                            ->options([\Jmeryar\Accounting\Enums\Accounting\AccountType::Payable->value => \Jmeryar\Accounting\Enums\Accounting\AccountType::Payable->label()])
                                            ->default(\Jmeryar\Accounting\Enums\Accounting\AccountType::Payable->value)
                                            ->required(),
                                    ])
                                ...
                                TranslatableSelect::forModel('default_tax_id', Tax::class, 'name')
                                    ...
                                    ->createOptionForm([
                                        ...
                                        Select::make('type')
                                            ...
                                            ->options([
                                                \Jmeryar\Accounting\Enums\Accounting\TaxType::Sales->value => \Jmeryar\Accounting\Enums\Accounting\TaxType::Sales->label(),
                                                \Jmeryar\Accounting\Enums\Accounting\TaxType::Purchase->value => \Jmeryar\Accounting\Enums\Accounting\TaxType::Purchase->label(),
                                                \Jmeryar\Accounting\Enums\Accounting\TaxType::Both->value => \Jmeryar\Accounting\Enums\Accounting\TaxType::Both->label(),
                                            ])
                                            ->default(\Jmeryar\Accounting\Enums\Accounting\TaxType::Both->value)
                                            ->required(),
                                    ])
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('type')
                    ->label(__('accounting::partner.type'))
                    ->formatStateUsing(fn (\Jmeryar\Foundation\Enums\Partners\PartnerType $state): string => $state->label())
                    ->badge()
                    ->color(fn (\Jmeryar\Foundation\Enums\Partners\PartnerType $state): string => match ($state) {
                        \Jmeryar\Foundation\Enums\Partners\PartnerType::Customer => 'success',
                        \Jmeryar\Foundation\Enums\Partners\PartnerType::Vendor => 'info',
                        \Jmeryar\Foundation\Enums\Partners\PartnerType::Both => 'warning',
                    })
                    ->icons([
                        'heroicon-m-user' => \Jmeryar\Foundation\Enums\Partners\PartnerType::Customer,
                        'heroicon-m-building-office' => \Jmeryar\Foundation\Enums\Partners\PartnerType::Vendor,
                        'heroicon-m-user-group' => \Jmeryar\Foundation\Enums\Partners\PartnerType::Both,
                    ])
                    ->searchable()
                    ->sortable(),
                ...
                MoneyColumn::make('customer_balance')
                    ...
                    ->getStateUsing(function (Partner $record) {
                        if (! in_array($record->type, [\Jmeryar\Foundation\Enums\Partners\PartnerType::Customer, \Jmeryar\Foundation\Enums\Partners\PartnerType::Both])) {
                            return null;
                        }
                ...
                MoneyColumn::make('vendor_balance')
                    ...
                    ->getStateUsing(function (Partner $record) {
                        if (! in_array($record->type, [\Jmeryar\Foundation\Enums\Partners\PartnerType::Vendor, \Jmeryar\Foundation\Enums\Partners\PartnerType::Both])) {
                            return null;
                        }
