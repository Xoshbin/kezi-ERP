            ...
            ->columns([
                ...
                TextColumn::make('source_type')
                    ...
                    ->formatStateUsing(function (?string $state): string {
                        ...
                        return match ($state) {
                            'Jmeryar\Accounting\Models\Payment' => __('payment.journal_entries_relation_manager.source_payment'),
                            'Jmeryar\Accounting\Models\BankStatementLine' => __('payment.journal_entries_relation_manager.source_reconciliation'),
                            'Jmeryar\Accounting\Models\Invoice' => __('payment.journal_entries_relation_manager.source_invoice'),
                            'Jmeryar\Accounting\Models\VendorBill' => __('payment.journal_entries_relation_manager.source_vendor_bill'),
                            default => class_basename($state),
                        };
                    })
                    ->badge()
                    ->color(fn (?string $state): string => match ($state) {
                        'Jmeryar\Accounting\Models\Payment' => 'primary',
                        'Jmeryar\Accounting\Models\BankStatementLine' => 'warning',
                        'Jmeryar\Accounting\Models\Invoice' => 'info',
                        'Jmeryar\Accounting\Models\VendorBill' => 'secondary',
                        default => 'gray',
                    })
                    ->toggleable(),
