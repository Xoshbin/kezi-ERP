...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\VendorBills;
...
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\VendorBills\RelationManagers\AdjustmentDocumentsRelationManager;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\VendorBills\RelationManagers\PaymentsRelationManager;
use Jmeryar\Accounting\Models\Account;
use Jmeryar\Accounting\Models\AssetCategory;
use Jmeryar\Accounting\Models\Journal;
use Jmeryar\Accounting\Models\Tax;
use Jmeryar\Accounting\Rules\NotInLockedPeriod;
        ...
        return $schema->components([
            \Filament\Forms\Components\Placeholder::make('shipping_warnings')
                ...
                ->content(function (?VendorBill $record) {
                    ...
                    $result = app(\Jmeryar\Purchase\Services\VendorBillService::class)->validateShippingCosts($record);
                                    ...
                                    Section::make(__('accounting::bill.shipping_assets'))
                                        ->schema([
                                            Select::make('shipping_cost_type')
                                                ...
                                                ->options(\Jmeryar\Foundation\Enums\ShippingCostType::class)
                                                ->placeholder(__('None'))
                                                ->nullable(),
                                            TranslatableSelect::forModel('asset_category_id', AssetCategory::class, 'name')
                                                ...
                                                ->createOptionForm([
                                                    ...
                                                    Select::make('asset_account_id')
                                                        ->options(\Jmeryar\Accounting\Models\Account::all()->pluck('name', 'id'))
                                                ...
                                                ->createOptionUsing(fn (array $data) => \Jmeryar\Accounting\Models\AssetCategory::create($data)->getKey()),
                                        ])
                                        ->columns(2),
                                ])
                                    ...
                                    if ($state) {
                                        ...
                                        if ($product) {
                                            ...
                                            if (str_contains($name, 'freight') || str_contains($name, 'shipping')) {
                                                $set('shipping_cost_type', \Jmeryar\Foundation\Enums\ShippingCostType::Freight);
                                            } elseif (str_contains($name, 'insurance')) {
                                                $set('shipping_cost_type', \Jmeryar\Foundation\Enums\ShippingCostType::Insurance);
                                            }
                                        }
                                    }
                                })
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('paymentState')
                    ...
                    ->formatStateUsing(fn (\Jmeryar\Foundation\Enums\Shared\PaymentState $state): string => $state->label())
                    ->badge()
                    ->color(fn (\Jmeryar\Foundation\Enums\Shared\PaymentState $state): string => $state->color()),
            ...
            ->recordActions([
                ActionGroup::make([
                    ...
                    Action::make('create_landed_cost')
                        ...
                        ->url(fn (VendorBill $record) => \Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\LandedCostResource::getUrl('create', [
