...
class EditAsset extends EditRecord
{
        ...
        return [
            ...
            DeleteAction::make()
                ->using(function ($record) {
                    ...
                    return app(\Jmeryar\Accounting\Services\AssetService::class)->delete($record);
                }),
        ];
    }
    ...
    protected function handleRecordUpdate(Model $record, array $data): Model
    {
        ...
        return DB::transaction(fn () => app(\Jmeryar\Accounting\Services\AssetService::class)->updateAsset($record, $dto));
    }
}
