...
use Jmeryar\Accounting\Actions\Accounting\BuildAdjustmentPostingPreviewAction;
...
use Jmeryar\Inventory\Actions\Adjustments\UpdateAdjustmentDocumentAction;
use Jmeryar\Inventory\DataTransferObjects\Adjustments\UpdateAdjustmentDocumentDTO;
use Jmeryar\Inventory\DataTransferObjects\Adjustments\UpdateAdjustmentDocumentLineDTO;
...
class EditAdjustmentDocument extends EditRecord
{
    ...
    protected function mutateFormDataBeforeFill(array $data): array
    {
        ...
        $lines = $rec->lines;
        $linesData = $lines->map(function (AdjustmentDocumentLine $line) {
            return [
