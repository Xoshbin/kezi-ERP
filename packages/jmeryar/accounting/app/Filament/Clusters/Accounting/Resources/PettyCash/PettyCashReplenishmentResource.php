...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\PettyCash;
...
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\PettyCash\PettyCashReplenishmentResource\Pages;
                    ...
                    ->schema([
                        Select::make('fund_id')
                            ...
                            ->afterStateUpdated(function ($state, callable $set) {
                                if ($state) {
                                    $fund = \Jmeryar\Payment\Models\PettyCash\PettyCashFund::find($state);
                                    if ($fund) {
