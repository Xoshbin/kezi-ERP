...
class CreateWithholdingTaxType extends CreateRecord
{
    ...
    {
        $action = app(\Jmeryar\Accounting\Actions\Accounting\CreateWithholdingTaxTypeAction::class);

        $dto = new \Jmeryar\Accounting\DataTransferObjects\Accounting\CreateWithholdingTaxTypeDTO(
            ...
            applicable_to: \Jmeryar\Accounting\Enums\Accounting\WithholdingTaxApplicability::from($data['applicable_to']),
