...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources;

use Filament\Resources\Resource;
use Jmeryar\Accounting\Filament\Clusters\Accounting\AccountingCluster;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\CurrencyRevaluationResource\Pages;
        ...
        return $table
            ->columns([
                ...
                \Filament\Tables\Columns\TextColumn::make('status')
                    ...
                    ->badge()
                    ->color(fn (\Jmeryar\Accounting\Enums\Currency\RevaluationStatus $state): string => $state->color())
                    ->formatStateUsing(fn (\Jmeryar\Accounting\Enums\Currency\RevaluationStatus $state): string => $state->label()),
