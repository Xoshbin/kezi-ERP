...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Accounts;
...
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Accounts\Pages\EditAccount;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Accounts\Pages\ListAccounts;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Accounts\RelationManagers\JournalEntryLinesRelationManager;
                        ...
                        ->schema([
                            Select::make('account_group_id')
                                ...
                                ->afterStateUpdated(function ($state, callable $set) {
                                    ...
                                    $group = \Jmeryar\Accounting\Models\AccountGroup::find($state);
                                    if (! $group) {
                                        return;
                                    }

                                    $service = app(\Jmeryar\Accounting\Services\AccountGroupService::class);
                        ...
                        ->schema([
                            ...
                            Toggle::make('can_create_assets')
                                ...
                                ->visible(fn ($get) => in_array($get('type'), [
                                    \Jmeryar\Accounting\Enums\Accounting\AccountType::FixedAssets->value,
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('type')
                    ->label(__('accounting::account.type'))
                    ->formatStateUsing(fn ($state) => $state instanceof \Jmeryar\Accounting\Enums\Accounting\AccountType ? $state->label() : $state)
                    ->searchable(),
