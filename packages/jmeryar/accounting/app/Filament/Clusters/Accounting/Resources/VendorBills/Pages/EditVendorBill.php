...
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\VendorBills\Widgets\SettlementSummaryWidget;
...
use Jmeryar\Purchase\Models\VendorBillAttachment;
        ...
        return [
            ...
            Action::make('post')
                ...
                ->action(function (VendorBill $record): void {
                    ...
                    } catch (\Jmeryar\Accounting\Exceptions\BudgetExceededException $e) {
                        Notification::make()
                            ->title($e->getMessage())
                            ->danger()
                            ->send();
    ...
    protected function handleRecordUpdate(Model $record, array $data): Model
    {
        ...
        foreach ($data['lines'] as $line) {
            $lineDTOs[] = new VendorBillLineDTO(
                ...
                shipping_cost_type: isset($line['shipping_cost_type']) ? \Jmeryar\Foundation\Enums\ShippingCostType::tryFrom($line['shipping_cost_type']) : null,
        ...
        $vendorBillDTO = new UpdateVendorBillDTO(
            ...
            incoterm: isset($data['incoterm']) ? \Jmeryar\Foundation\Enums\Incoterm::tryFrom($data['incoterm']) : null
        );

        try {
            $updatedVendorBill = app(UpdateVendorBillAction::class)->execute($vendorBillDTO);
        } catch (\Jmeryar\Foundation\Exceptions\UpdateNotAllowedException $e) {
            Notification::make()
