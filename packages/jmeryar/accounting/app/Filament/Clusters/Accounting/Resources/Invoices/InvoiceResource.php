...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Invoices;
...
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Invoices\RelationManagers\AdjustmentDocumentsRelationManager;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Invoices\RelationManagers\InvoiceLinesRelationManager;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Invoices\RelationManagers\PaymentsRelationManager;
...
use Jmeryar\Foundation\Filament\Helpers\DocumentAttachmentsHelper;
                            ...
                            TranslatableSelect::forModel('product_id', Product::class, 'name')
                                ...
                                ->createOptionForm([
                                    ...
                                    TranslatableSelect::forModel('default_inventory_account_id', Account::class, 'name')
                                        ...
                                        ->visible(fn ($get) => $get('type') === \Jmeryar\Product\Enums\Products\ProductType::Storable->value)
                                        ->required(fn ($get) => $get('type') === \Jmeryar\Product\Enums\Products\ProductType::Storable->value)
