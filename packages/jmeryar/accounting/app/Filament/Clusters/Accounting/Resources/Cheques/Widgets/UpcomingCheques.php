...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Cheques\Widgets;
...
use Jmeryar\Payment\Services\Cheques\ChequeMaturityService;
...
class UpcomingCheques extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->actions([
                Action::make('view')
                    ->url(fn (Cheque $record) => \Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Cheques\ChequeResource::getUrl('edit', ['record' => $record])),
            ]);
    }
}
