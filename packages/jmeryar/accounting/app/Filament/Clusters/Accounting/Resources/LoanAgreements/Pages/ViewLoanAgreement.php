...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\LoanAgreements\Pages;
...
use Jmeryar\Accounting\Actions\Loans\AccrueLoanInterestAction;
use Jmeryar\Accounting\Actions\Loans\BuildLoanPaymentJournalEntryAction;
use Jmeryar\Accounting\Actions\Loans\CalculateEIRAction;
use Jmeryar\Accounting\Actions\Loans\ComputeLoanScheduleAction;
use Jmeryar\Accounting\Actions\Loans\ReclassifyLoanCurrentPortionAction;
                ...
                ->form([
                    ...
                    Select::make('interest_account_id')
                        ...
                        ->createOptionForm([
                            ...
                            TextInput::make('name')->required(),
                            Select::make('type')->options(
                                collect(\Jmeryar\Accounting\Enums\Accounting\AccountType::cases())->mapWithKeys(fn ($t) => [$t->value => $t->label()])
                            )->required(),
                        ])
