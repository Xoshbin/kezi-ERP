...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Cheques;
...
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Cheques\ChequebookResource\Pages;
                ...
                Section::make(__('accounting::cheque.details'))
                    ->schema([
                        ...
                        Select::make('journal_id')
                            ...
                            ->options(function () {
                                return \Jmeryar\Accounting\Models\Journal::where('type', \Jmeryar\Accounting\Enums\Accounting\JournalType::Bank)
                                    ->pluck('name', 'id');
                            })
                            ->required()
                            ->searchable(),
