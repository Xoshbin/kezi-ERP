...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\LoanAgreements\Schemas;
                ...
                ->schema([
                    TranslatableSelect::make('partner_id')
                        ...
                        ->createOptionForm([
                            ...
                            Select::make('type')->label(__('partner.type') ?: 'Type')->options(\Jmeryar\Foundation\Enums\Partners\PartnerType::class)->required(),
