...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Assets;
...
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Assets\Pages\CreateAsset;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Assets\Pages\EditAsset;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Assets\Pages\ListAssets;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Assets\RelationManagers\DepreciationEntryRelationManager;
        ...
        return $schema->components([
            ...
            Section::make(__('accounting::asset.asset_details'))
                ...
                ->schema([
                    ...
                    \Jmeryar\Foundation\Filament\Forms\Components\MoneyInput::make('purchase_value')
                        ->label(__('accounting::asset.purchase_value'))
                        ->currencyField('../../company.currency_id')
                        ->required()
                        ->columnSpan(1),

                    \Jmeryar\Foundation\Filament\Forms\Components\MoneyInput::make('salvage_value')
                    ...
                    Select::make('asset_account_id')
                        ...
                        ->createOptionForm([
                            ...
                            Select::make('type')
                                ...
                                ->default(\Jmeryar\Accounting\Enums\Accounting\AccountType::FixedAssets->value)
                                ->required(),
                        ])
                    ...
                    Select::make('depreciation_expense_account_id')
                        ...
                        ->createOptionForm([
                            ...
                            Select::make('type')
                                ->label(__('accounting::account.type'))
                                ->options(collect(\Jmeryar\Accounting\Enums\Accounting\AccountType::cases())->mapWithKeys(fn ($t) => [$t->value => $t->label()]))
                                ->default(\Jmeryar\Accounting\Enums\Accounting\AccountType::Depreciation->value)
                                ->required(),
                        ])
                        ->createOptionModalHeading(__('accounting::common.modal_title_create_account'))
                        ->createOptionAction(fn (Action $action) => $action->modalWidth('lg'))
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                \Jmeryar\Foundation\Filament\Tables\Columns\MoneyColumn::make('purchase_value')
                    ->label(__('accounting::asset.purchase_value'))
                    ->sortable()
                    ->weight('bold')
                    ->size('lg'),
