...
namespace Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Partners\Widgets;
...
class VendorFinancialWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        if (! in_array($partner->type, [\Jmeryar\Foundation\Enums\Partners\PartnerType::Vendor, \Jmeryar\Foundation\Enums\Partners\PartnerType::Both])) {
            return [];
        }
        ...
        $stats[] = Stat::make(__('accounting::partner.widgets.total_to_pay'), $outstandingBalance->formatTo('en_US'))
        ...
        $stats[] = Stat::make(__('accounting::partner.widgets.due_within_7_days'), $dueIn7Days->formatTo('en_US'))
            ->description(__('accounting::partner.widgets.urgent_payments'))
        ...
        //     ->description(__('accounting::partner.widgets.our_payment_performance'))
        ...
        $stats[] = Stat::make(__('accounting::partner.widgets.paid_last_month'), $monthlyPaid->formatTo('en_US'))
            ->description(__('accounting::partner.widgets.last_month_payments'))
