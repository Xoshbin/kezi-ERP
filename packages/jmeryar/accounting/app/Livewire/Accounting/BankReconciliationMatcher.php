...
namespace Jmeryar\Accounting\Livewire\Accounting;
...
use Jmeryar\Accounting\Models\Company;
...
class BankReconciliationMatcher extends Component
{
    ...
    public function summary(): array
    {
        ...
        return [
            ...
            'bankTotalFormatted' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($this->bankTotal),
            'systemTotalFormatted' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($this->systemTotal),
            'differenceFormatted' => \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo($difference),
        ];
    }
    ...
    public function reconcile(): void
    {
        ...
        app(\Jmeryar\Accounting\Services\BankReconciliationService::class)->reconcileMultiple(
