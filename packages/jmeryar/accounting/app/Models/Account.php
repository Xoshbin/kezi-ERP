 ...
 *
 * @method static \Jmeryar\Accounting\Database\Factories\AccountFactory factory($count = null, $state = [])
 ...
 * @mixin Eloquent
 */
#[ObservedBy([\Jmeryar\Accounting\Observers\AccountObserver::class, \Jmeryar\Foundation\Observers\AuditLogObserver::class])] // (to log when accounts are created or deprecated)
class Account extends Model
{
    use HasFactory;

    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\AccountFactory
    {
        return \Jmeryar\Accounting\Database\Factories\AccountFactory::new();
    }
    ...
    protected $casts = [
        ...
        'type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::class, // Enums provide type safety and clarity [12]
    ];
    ...
    */
     ...
     */
    public function getRootTypeAttribute(): \Jmeryar\Accounting\Enums\Accounting\RootAccountType
    {
