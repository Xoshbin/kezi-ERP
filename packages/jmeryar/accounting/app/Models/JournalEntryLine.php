...
use Jmeryar\Accounting\Database\Factories\JournalEntryLineFactory;
use Jmeryar\Accounting\Observers\JournalEntryLineObserver;
...
class JournalEntryLine extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\JournalEntryLineFactory
    {
        return \Jmeryar\Accounting\Database\Factories\JournalEntryLineFactory::new();
    }
    ...
    protected $casts = [
        ...
        'debit' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'credit' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,

        // This field is in the foreign currency
        'original_currency_amount' => \Jmeryar\Foundation\Casts\OriginalCurrencyMoneyCast::class,
