...
class LoanScheduleEntry extends Model
{
    ...
    protected $casts = [
        'due_date' => 'date',
        'payment_amount' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'principal_component' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'interest_component' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'outstanding_balance_after' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
