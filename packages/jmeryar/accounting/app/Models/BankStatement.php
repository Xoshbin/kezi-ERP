...
class BankStatement extends Model
{
    ...
    protected $casts = [
        'date' => 'date',
        'starting_balance' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'ending_balance' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
    ];
    ...
    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\BankStatementFactory
    {
        return \Jmeryar\Accounting\Database\Factories\BankStatementFactory::new();
    }
}
