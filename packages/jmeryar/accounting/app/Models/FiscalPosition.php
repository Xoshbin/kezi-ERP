...
class FiscalPosition extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\FiscalPositionFactory
    {
        return \Jmeryar\Accounting\Database\Factories\FiscalPositionFactory::new();
    }
