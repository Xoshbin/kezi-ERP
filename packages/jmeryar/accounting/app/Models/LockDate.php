...
use Jmeryar\Accounting\Database\Factories\LockDateFactory;
use Jmeryar\Accounting\Enums\Accounting\LockDateType;
use Jmeryar\Accounting\Observers\LockDateObserver;
...
class LockDate extends Model
{
    ...
    {
        return \Jmeryar\Accounting\Database\Factories\LockDateFactory::new();
    }
}
