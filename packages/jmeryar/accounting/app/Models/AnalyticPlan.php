...
class AnalyticPlan extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\AnalyticPlanFactory
    {
        return \Jmeryar\Accounting\Database\Factories\AnalyticPlanFactory::new();
    }
