...
use Jmeryar\Accounting\Database\Factories\JournalEntryFactory;
use Jmeryar\Accounting\Enums\Accounting\JournalEntryState;
use Jmeryar\Accounting\Observers\JournalEntryObserver;
...
class JournalEntry extends Model
{
    ...
    protected $casts = [
        'entry_date' => 'date',
        'total_debit' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
        'total_credit' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
