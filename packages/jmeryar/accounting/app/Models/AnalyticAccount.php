...
class AnalyticAccount extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\AnalyticAccountFactory
    {
        return \Jmeryar\Accounting\Database\Factories\AnalyticAccountFactory::new();
    }
