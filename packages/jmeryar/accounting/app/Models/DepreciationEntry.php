...
use Jmeryar\Accounting\Database\Factories\DepreciationEntryFactory;
use Jmeryar\Accounting\Enums\Assets\DepreciationEntryStatus;
use Jmeryar\Accounting\Observers\DepreciationEntryObserver;
...
class DepreciationEntry extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\DepreciationEntryFactory
    {
        return \Jmeryar\Accounting\Database\Factories\DepreciationEntryFactory::new();
    }
    ...
    protected $casts = [
        ...
        'amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class, // Ensures precision for currency amounts
