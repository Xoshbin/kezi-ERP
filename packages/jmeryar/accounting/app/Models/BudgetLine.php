...
class BudgetLine extends Model
{
     ...
     */
    protected $casts = [
        'budgeted_amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'achieved_amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'committed_amount' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'created_at' => 'datetime',
        'updated_at' => 'datetime',
    ];
    ...
    */
    ...
    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\BudgetLineFactory
    {
        return \Jmeryar\Accounting\Database\Factories\BudgetLineFactory::new();
    }
}
