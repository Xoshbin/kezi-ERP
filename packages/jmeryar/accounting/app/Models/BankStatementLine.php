...
use Jmeryar\Accounting\Database\Factories\BankStatementLineFactory;
use Jmeryar\Accounting\Observers\BankStatementLineObserver;
use Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast;
use Jmeryar\Foundation\Casts\OriginalCurrencyMoneyCast;
...
class BankStatementLine extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Accounting\Database\Factories\BankStatementLineFactory
    {
        return \Jmeryar\Accounting\Database\Factories\BankStatementLineFactory::new();
    }
    ...
    protected $casts = [
        ...
        'amount_in_foreign_currency' => \Jmeryar\Foundation\Casts\OriginalCurrencyMoneyCast::class,
