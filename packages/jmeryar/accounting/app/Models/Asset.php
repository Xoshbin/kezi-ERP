...
class Asset extends Model
{
    ...
    protected $casts = [
        'purchase_date' => 'date',
        'purchase_value' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'salvage_value' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
