...
use Carbon\Carbon;
use Jmeryar\Accounting\DataTransferObjects\Reports\Consolidation\ConsolidatedTrialBalanceDTO;
use Jmeryar\Accounting\DataTransferObjects\Reports\Consolidation\ConsolidatedTrialBalanceLineDTO;
use Jmeryar\Accounting\Services\Consolidation\CurrencyTranslationService;
use Jmeryar\Accounting\Services\Consolidation\InterCompanyEliminationService;
use Jmeryar\Accounting\Services\Reports\TrialBalanceService;
    ...
    public function generate(Company $parentCompany, Carbon $asOfDate): ConsolidatedTrialBalanceDTO
    {
        ...
        foreach ($companies as $company) {
            ...
            foreach ($tb->reportLines as $line) {
                ...
                $method = match ($line->accountType) {
                    \Jmeryar\Accounting\Enums\Accounting\AccountType::Income,
                    \Jmeryar\Accounting\Enums\Accounting\AccountType::Expense => \Jmeryar\Accounting\Enums\Consolidation\CurrencyTranslationMethod::AverageRate,
                    default => \Jmeryar\Accounting\Enums\Consolidation\CurrencyTranslationMethod::ClosingRate,
                };
        ...
        foreach ($eliminationLines as $jeLine) {
            ...
            $convertedDebitElim = $this->currencyTranslationService->translate(
                ...
                $parentCompany->currency,
                $asOfDate,
                \Jmeryar\Accounting\Enums\Consolidation\CurrencyTranslationMethod::ClosingRate, // Balances are usually Closing
                $parentCompany
            );
            ...
            $convertedCreditElim = $this->currencyTranslationService->translate(
                ...
                $parentCompany->currency,
                $asOfDate,
                \Jmeryar\Accounting\Enums\Consolidation\CurrencyTranslationMethod::ClosingRate,
                $parentCompany
            );
