...
use Jmeryar\Accounting\DataTransferObjects\Reports\FxGainLossLineDTO;
use Jmeryar\Accounting\DataTransferObjects\Reports\FxGainLossReportDTO;
...
class FxGainLossReportService
{
    ...
    protected function getUnrealizedGainsLosses(Company $company, Carbon $startDate, Carbon $endDate): Collection
    {
        ...
        $results = DB::table('currency_revaluation_lines as crl')
            ...
            ->where('cr.status', \Jmeryar\Accounting\Enums\Currency\RevaluationStatus::Posted->value)
