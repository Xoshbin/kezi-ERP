...
use Jmeryar\Accounting\DataTransferObjects\Reports\TaxReportDTO;
use Jmeryar\Accounting\DataTransferObjects\Reports\TaxReportLineDTO;
...
class TaxReportService
{
    ...
    public function generateSpecificReport(string $generatorClass, Company $company, Carbon $startDate, Carbon $endDate): array
    {
        ...
        if (! $generator instanceof \Jmeryar\Accounting\Services\Reports\Generators\TaxReportGeneratorContract) {
