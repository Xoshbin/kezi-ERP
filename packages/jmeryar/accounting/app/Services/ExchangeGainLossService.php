...
class ExchangeGainLossService
{
    ...
    protected function postRealizedGainLossEntry(
        ...
        return app(\Jmeryar\Accounting\Actions\Accounting\CreateJournalEntryAction::class)->execute($entryDTO);
    }
     ...
     * @return \Illuminate\Database\Eloquent\Collection<int, \Jmeryar\Accounting\Models\Account>
     */
     ...
     */
    protected function getForeignCurrencyBalances(\Jmeryar\Accounting\Models\Account $account, Carbon $date): array
    {
    ...
    protected function postUnrealizedGainLossEntry(
        Company $company,
        \Jmeryar\Accounting\Models\Account $account,
        Currency $currency,
