...
namespace Jmeryar\Accounting\Actions\Dunning;
...
class ProcessDunningRunAction
{
    public function __construct(
        private readonly \Jmeryar\Sales\Actions\Sales\CreateInvoiceAction $createInvoiceAction,
    ) {}
    ...
    private function createDebitNote(Invoice $invoice, DunningLevel $level): void
    {
        ...
        if (! $incomeAccount && $product->income_account_id) {
            $incomeAccount = \Jmeryar\Accounting\Models\Account::find($product->income_account_id);
        }
        ...
        $lineDto = new \Jmeryar\Sales\DataTransferObjects\Sales\CreateInvoiceLineDTO(
