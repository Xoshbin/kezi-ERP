...
class CreateJournalEntryForChequeAction
{
    public function __construct(
        private readonly \Jmeryar\Accounting\Actions\Accounting\CreateJournalEntryAction $createJournalEntryAction,
    ) {}
    ...
    public function execute(Cheque $cheque, string $context): ?JournalEntry
    {
        return DB::transaction(function () use ($cheque, $context) {
            ...
            foreach ($linesData as $line) {
                $lineDTOs[] = new \Jmeryar\Accounting\DataTransferObjects\Accounting\CreateJournalEntryLineDTO(
