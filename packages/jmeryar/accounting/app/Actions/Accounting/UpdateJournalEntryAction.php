...
use Jmeryar\Accounting\DataTransferObjects\Accounting\UpdateJournalEntryDTO;
...
class UpdateJournalEntryAction
{
    ...
    public function execute(UpdateJournalEntryDTO $dto): JournalEntry
    {
        ...
        if ($journalEntry->is_posted) {
            throw new \Jmeryar\Foundation\Exceptions\UpdateNotAllowedException('Cannot modify a posted journal entry.');
        }
