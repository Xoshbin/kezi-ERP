...
class NotInLockedPeriod implements ValidationRule
{
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        try {
            ...
            app(\Jmeryar\Accounting\Services\Accounting\LockDateService::class)->enforce($this->company, $date);
        } catch (\Jmeryar\Accounting\Exceptions\PeriodIsLockedException $e) {
            $fail($e->getMessage());
        }
    }
}
