...
namespace Jmeryar\Accounting\Tests\Feature\Assets;
...
it('converts asset purchase value to company currency', function () {
    ...
    // Create USD Currency
    $usd = \Jmeryar\Foundation\Models\Currency::factory()->create([
        'code' => 'USD',
        'name' => 'US Dollar',
        'symbol' => '$',
    ]);
    ...
    $asset = \Jmeryar\Accounting\Models\Asset::where('source_id', $vendorBill->id)->first();
...
it('does not create asset for zero value line', function () {
    ...
    $assets = \Jmeryar\Accounting\Models\Asset::where('source_id', $vendorBill->id)->get();
