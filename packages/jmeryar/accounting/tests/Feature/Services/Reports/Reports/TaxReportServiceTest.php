...
test('it generates a tax report with sales tax only', function () {
    ...
    $salesTaxAccount = Account::factory()->for($company)->create(['type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::CurrentLiabilities]);
    ...
    JournalEntryLine::factory()->create([
        ...
        'account_id' => Account::factory()->for($company)->create(['type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::Receivable])->id,
    ...
    JournalEntryLine::factory()->create([
        'journal_entry_id' => $journalEntry->id,
        'account_id' => Account::factory()->for($company)->create(['type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::Income])->id,
    ...
    // Action
    $service = app(\Jmeryar\Accounting\Services\Reports\TaxReportService::class);
...
test('it generates a tax report with purchase tax only', function () {
    ...
    $purchaseTaxAccount = Account::factory()->for($company)->create(['type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::CurrentAssets]);
    ...
    JournalEntryLine::factory()->create([
        'journal_entry_id' => $journalEntry->id,
        'account_id' => Account::factory()->for($company)->create(['type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::Expense])->id,
    ...
    JournalEntryLine::factory()->create([
        'journal_entry_id' => $journalEntry->id,
        'account_id' => Account::factory()->for($company)->create(['type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::Payable])->id,
        'debit' => Money::zero($currency),
...
test('it handles multiple tax rates correctly', function () {
    ...
    // Create 15% sales tax
    $salesTax15Account = Account::factory()->for($company)->create(['type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::CurrentLiabilities]);
    ...
    // Create 10% sales tax
    $salesTax10Account = Account::factory()->for($company)->create(['type' => \Jmeryar\Accounting\Enums\Accounting\AccountType::CurrentLiabilities]);
