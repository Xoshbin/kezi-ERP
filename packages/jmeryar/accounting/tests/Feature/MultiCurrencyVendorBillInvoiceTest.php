...
namespace Jmeryar\Accounting\Tests\Feature;
...
beforeEach(function () {
    ...
    $this->vendor = Partner::factory()->for($this->company)->create(['type' => \Jmeryar\Foundation\Enums\Partners\PartnerType::Vendor]);
    $this->customer = Partner::factory()->for($this->company)->create(['type' => \Jmeryar\Foundation\Enums\Partners\PartnerType::Customer]);
    ...
    $this->product = Product::factory()->for($this->company)->create([
        'type' => \Jmeryar\Product\Enums\Products\ProductType::Service, // Use service type to avoid inventory movements
