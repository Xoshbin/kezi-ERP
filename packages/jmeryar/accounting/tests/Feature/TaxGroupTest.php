...
use Jmeryar\Accounting\Actions\Accounting\CreateJournalEntryForInvoiceAction;
use Jmeryar\Accounting\Actions\Accounting\CreateJournalEntryForVendorBillAction;
...
test('it handles mixed recoverability in vendor bills for tax groups', function () {
    ...
    $bill = VendorBill::factory()->create([
        'company_id' => $this->company->id,
        'currency_id' => $this->currency->id,
        'vendor_id' => \Jmeryar\Foundation\Models\Partner::factory()->create()->id,
