...
describe('VendorBill Exchange Rate Field', function () {
    ...
    test('exchange rate field exists for posted vendor bills', function () {
        ...
        $livewire = Livewire::test(\Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\VendorBills\Pages\ViewVendorBill::class, ['record' => $vendorBill->id]);
    ...
    test('exchange rate field exists for posted invoices', function () {
        ...
        $livewire = Livewire::test(\Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Invoices\Pages\ViewInvoice::class, ['record' => $invoice->id]);
