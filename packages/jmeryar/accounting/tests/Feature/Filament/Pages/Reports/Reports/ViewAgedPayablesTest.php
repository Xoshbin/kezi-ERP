...
namespace Jmeryar\Accounting\Tests\Feature\Filament\Pages\Reports;

use Brick\Money\Money;
use Carbon\Carbon;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Livewire\Livewire;
use Jmeryar\Accounting\Filament\Clusters\Accounting\Pages\Reports\ViewAgedPayables;
...
test('it can generate aged payables report', function () {
    ...
    // Action & Assert
    $expectedAmount = \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(1000, $currency));
    Livewire::test(ViewAgedPayables::class)
        ->fillForm([
...
test('it displays correct aging buckets', function () {
    ...
    // Action & Assert
    $amount1 = \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(1000, $currency));
    $amount2 = \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(2000, $currency));
    $amount3 = \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(3000, $currency));
    $total = \Jmeryar\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(6000, $currency));
