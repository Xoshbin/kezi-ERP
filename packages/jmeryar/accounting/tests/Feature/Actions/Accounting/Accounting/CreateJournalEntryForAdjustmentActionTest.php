...
use Jmeryar\Accounting\Actions\Accounting\CreateJournalEntryForAdjustmentAction;
...
test('it creates a correct journal entry for a posted adjustment document (credit note)', function () {
    ...
    $adjustment = AdjustmentDocument::factory()
        ...
        ->create([
            ...
            'type' => \Jmeryar\Inventory\Enums\Adjustments\AdjustmentDocumentType::CreditNote,
        ]);
...
test('it creates a correct journal entry for a posted debit note (vendor return)', function () {
    // 1. Arrange
    $vendorBill = \Jmeryar\Purchase\Models\VendorBill::factory()
        ->for($this->company)
        ->create([
            'currency_id' => $this->company->currency_id,
        ]);
    ...
    $adjustment = AdjustmentDocument::factory()
        ...
        ->create([
            'currency_id' => $this->company->currency_id,
            'type' => \Jmeryar\Inventory\Enums\Adjustments\AdjustmentDocumentType::DebitNote,
