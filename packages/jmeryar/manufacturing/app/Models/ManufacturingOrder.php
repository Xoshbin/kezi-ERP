 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\Jmeryar\Manufacturing\Models\ManufacturingOrderLine[] $lines
 * @property-read \Illuminate\Database\Eloquent\Collection|\Jmeryar\Manufacturing\Models\WorkOrder[] $workOrders
 */
class ManufacturingOrder extends Model
{
    use HasFactory;

    protected static function newFactory(): \Jmeryar\Manufacturing\Database\Factories\ManufacturingOrderFactory
    {
        return \Jmeryar\Manufacturing\Database\Factories\ManufacturingOrderFactory::new();
    }
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\MorphMany<\Jmeryar\QualityControl\Models\QualityCheck>
     */
    public function qualityChecks(): \Illuminate\Database\Eloquent\Relations\MorphMany
    {
        return $this->morphMany(\Jmeryar\QualityControl\Models\QualityCheck::class, 'source');
    }
