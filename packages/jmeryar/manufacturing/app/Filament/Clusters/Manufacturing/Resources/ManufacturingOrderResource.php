...
namespace Jmeryar\Manufacturing\Filament\Clusters\Manufacturing\Resources;
...
use Jmeryar\Manufacturing\Filament\Clusters\Manufacturing\ManufacturingCluster;
use Jmeryar\Manufacturing\Filament\Clusters\Manufacturing\Resources\ManufacturingOrderResource\Pages;
use Jmeryar\Manufacturing\Filament\Clusters\Manufacturing\Resources\ManufacturingOrderResource\RelationManagers;
                ...
                ->schema([
                    ...
                    Forms\Components\Select::make('bom_id')
                        ...
                        ->afterStateUpdated(function ($state, callable $set) {
                            if ($state) {
                                $bom = \Jmeryar\Manufacturing\Models\BillOfMaterial::find($state);
                                if ($bom) {
        ...
        return $table
            ...
            ->actions([
                ...
                FilamentAction::make('cancel')
                    ...
                    ->visible(fn (ManufacturingOrder $record) => in_array($record->status, [
                    ...
                    ->action(function (ManufacturingOrder $record) {
                        try {
                            app(\Jmeryar\Manufacturing\Services\ManufacturingOrderService::class)->cancel($record);
