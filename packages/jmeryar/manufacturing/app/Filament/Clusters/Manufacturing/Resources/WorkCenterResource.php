...
use Jmeryar\Manufacturing\Filament\Clusters\Manufacturing\Resources\WorkCenterResource\Pages;
        ...
        return $schema->components([
            Section::make(__('manufacturing::manufacturing.work_center.label'))
                ->schema([
                    ...
                    \Jmeryar\Foundation\Filament\Forms\Components\MoneyInput::make('hourly_cost')
