...
use Jmeryar\HR\Filament\Clusters\HumanResources\Resources\Payrolls\Pages\CreatePayroll;
use Jmeryar\HR\Filament\Clusters\HumanResources\Resources\Payrolls\Pages\EditPayroll;
use Jmeryar\HR\Filament\Clusters\HumanResources\Resources\Payrolls\Pages\ListPayrolls;
...
describe('PayrollResource', function () {
    ...
    it('can create payment via table action', function () {
        ...
        $salaryExpenseAccount = \Jmeryar\Accounting\Models\Account::factory()->for($this->company)->create(['type' => 'expense']);
        $salaryPayableAccount = \Jmeryar\Accounting\Models\Account::factory()->for($this->company)->create(['type' => 'current_liabilities']);
        $bankAccount = \Jmeryar\Accounting\Models\Account::factory()->for($this->company)->create(['type' => 'current_assets']);
        $bankJournal = \Jmeryar\Accounting\Models\Journal::factory()->for($this->company)->create([
            'type' => \Jmeryar\Accounting\Enums\Accounting\JournalType::Bank,
