...
test('it processes payroll correctly', function () {
    ...
    /** @var \Jmeryar\HR\Models\Employee $employee */
...
test('it generates correct accounting lines with balanced debits and credits', function () {
    ...
    $salaryExpenseAccount = \Jmeryar\Accounting\Models\Account::factory()->create(['company_id' => $this->company->id]);
    $salaryPayableAccount = \Jmeryar\Accounting\Models\Account::factory()->create(['company_id' => $this->company->id]);
