...
use Jmeryar\HR\Actions\HumanResources\CreatePayrollLineAction;
use Jmeryar\HR\DataTransferObjects\HumanResources\PayrollLineDTO;
use Jmeryar\HR\Models\Payroll;
use Jmeryar\HR\Models\PayrollLine;
...
it('can create a payroll line with valid data (Happy Path)', function () {
    ...
    /** @var \Jmeryar\Foundation\Models\Currency $currency */
    $currency = Currency::factory()->create(['code' => 'USD']);

    /** @var \Jmeryar\HR\Models\Payroll $payroll */
    $payroll = Payroll::factory()->create([
        'company_id' => $company->id,
        'currency_id' => $currency->id,
    ]);

    /** @var \Jmeryar\Accounting\Models\Account $account */
