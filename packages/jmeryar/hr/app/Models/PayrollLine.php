...
use Jmeryar\HR\Casts\PayrollCurrencyMoneyCast;
 ...
 * @property-read \Jmeryar\HR\Models\Payroll $payroll
 * @property-read \Jmeryar\Accounting\Models\Account $account
 * @property-read \Jmeryar\Accounting\Models\AnalyticAccount|null $analyticAccount
 */
class PayrollLine extends Model
{
    ...
    protected $casts = [
        ...
        'amount_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'tax_rate' => 'decimal:2',
        'is_taxable' => 'boolean',
