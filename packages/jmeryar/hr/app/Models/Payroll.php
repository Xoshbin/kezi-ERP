...
use Jmeryar\HR\Observers\PayrollObserver;
 ...
 */
#[ObservedBy([\Jmeryar\Foundation\Observers\AuditLogObserver::class, PayrollObserver::class])]
class Payroll extends Model
{
    ...
    {
        return \Jmeryar\HR\Database\Factories\PayrollFactory::new();
    }
    ...
    protected $casts = [
        ...
        'pay_date' => 'date',
        'base_salary' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'overtime_amount' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'housing_allowance' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'transport_allowance' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'meal_allowance' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'other_allowances' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'bonus' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'commission' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'gross_salary' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'income_tax' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'social_security' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'health_insurance' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'pension_contribution' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'other_deductions' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'total_deductions' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'net_salary' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
