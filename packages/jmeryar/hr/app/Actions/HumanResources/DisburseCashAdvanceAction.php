...
class DisburseCashAdvanceAction
{
    ...
    public function execute(CashAdvance $cashAdvance, int $bankAccountId, User $user): void
    {
        DB::transaction(function () use ($cashAdvance, $bankAccountId, $user) {
            ...
            if (! $journalId) {
                $cashJournal = \Jmeryar\Accounting\Models\Journal::where('company_id', $company->id)
                    ->whereIn('type', [
                        \Jmeryar\Accounting\Enums\Accounting\JournalType::Cash,
                        \Jmeryar\Accounting\Enums\Accounting\JournalType::Bank,
                    ])
                    ->first();
            ...
            $partner = \Jmeryar\Foundation\Models\Partner::firstOrCreate(
                [
            ...
            $paymentDTO = new CreatePaymentDTO(
                ...
                payment_type: \Jmeryar\Payment\Enums\Payments\PaymentType::Outbound,
