...
namespace Jmeryar\HR\Filament\Clusters\HumanResources\Resources\EmploymentContracts\Tables;
...
class EmploymentContractsTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                CreateAction::make()
                    ->using(function (array $data): \Jmeryar\HR\Models\EmploymentContract {
            ...
            ->actions([
                EditAction::make()
                    ->using(function (\Jmeryar\HR\Models\EmploymentContract $record, array $data): \Jmeryar\HR\Models\EmploymentContract {
