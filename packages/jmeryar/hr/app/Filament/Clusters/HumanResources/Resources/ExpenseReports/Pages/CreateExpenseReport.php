...
{
    protected static string $resource = \Jmeryar\HR\Filament\Clusters\HumanResources\Resources\ExpenseReports\ExpenseReportResource::class;

    protected function handleRecordCreation(array $data): \Illuminate\Database\Eloquent\Model
    {
        $cashAdvance = \Jmeryar\HR\Models\CashAdvance::findOrFail($data['cash_advance_id']);
        ...
        $lines = collect($linesData)->map(function ($line) use ($currencyCode) {
            return new \Jmeryar\HR\DataTransferObjects\HumanResources\ExpenseReportLineDTO(
        ...
        $dto = new \Jmeryar\HR\DataTransferObjects\HumanResources\CreateExpenseReportDTO(
        ...
        return app(\Jmeryar\HR\Actions\HumanResources\CreateExpenseReportActionV3::class)->execute($dto, auth()->user());
    }
}
