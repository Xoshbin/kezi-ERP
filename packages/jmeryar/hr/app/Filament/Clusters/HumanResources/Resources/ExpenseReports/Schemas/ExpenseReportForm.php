...
namespace Jmeryar\HR\Filament\Clusters\HumanResources\Resources\ExpenseReports\Schemas;
                        ...
                        Repeater::make('lines')
                            ->schema([
                                Select::make('expense_account_id')
                                    ...
                                    ->options(\Jmeryar\Accounting\Models\Account::where('type', \Jmeryar\Accounting\Enums\Accounting\AccountType::Expense)->get()->pluck('name', 'id'))
                                    ->searchable()
                                    ->required()
                                    ->columnSpan(2),
                                ...
                                Select::make('partner_id')
                                    ...
                                    ->options(\Jmeryar\Foundation\Models\Partner::get()->pluck('name', 'id'))
                                    ->searchable(),
