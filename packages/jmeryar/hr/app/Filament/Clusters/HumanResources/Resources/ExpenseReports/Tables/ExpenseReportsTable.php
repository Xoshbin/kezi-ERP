...
namespace Jmeryar\HR\Filament\Clusters\HumanResources\Resources\ExpenseReports\Tables;
        ...
        return $table
            ...
            ->filters([
                \Filament\Tables\Filters\SelectFilter::make('status')
                    ->options(\Jmeryar\HR\Enums\ExpenseReportStatus::class),
            ...
            ->recordActions([
                ...
                \Filament\Actions\EditAction::make()
                    ->visible(fn ($record) => $record->status === \Jmeryar\HR\Enums\ExpenseReportStatus::Draft),
                \Filament\Actions\Action::make('submit')
                    ...
                    ->action(function ($record) {
                        app(\Jmeryar\HR\Services\HumanResources\CashAdvanceService::class)->submitExpenseReport($record, auth()->user());
                    }),
                \Filament\Actions\Action::make('approve')
                    ...
                    ->color('success')
                    ->requiresConfirmation()
                    ->visible(fn ($record) => $record->status === \Jmeryar\HR\Enums\ExpenseReportStatus::Submitted)
                    ->action(function ($record) {
                        app(\Jmeryar\HR\Services\HumanResources\CashAdvanceService::class)->approveExpenseReport($record, auth()->user());
                    }),
            ])
            ->toolbarActions([
