...
namespace Jmeryar\HR\DataTransferObjects\EmploymentContracts;
...
readonly class EmploymentContractDTO
{
    ...
    public static function fromArray(array $data, string $currencyCode): self
    {
        return new self(
            ...
            base_salary: static::toMoney($data['base_salary'] ?? 0, $currencyCode),
            pay_frequency: $data['pay_frequency'],
            housing_allowance: static::toMoney($data['housing_allowance'] ?? 0, $currencyCode),
            transport_allowance: static::toMoney($data['transport_allowance'] ?? 0, $currencyCode),
            meal_allowance: static::toMoney($data['meal_allowance'] ?? 0, $currencyCode),
            other_allowances: static::toMoney($data['other_allowances'] ?? 0, $currencyCode),
            ...
            hourly_rate: isset($data['hourly_rate']) ? static::toMoney($data['hourly_rate'], $currencyCode) : null,
