...
use Jmeryar\Manufacturing\Models\ManufacturingOrderLine;
...
describe('Manufacturing Quality Gate', function () {
    it('allows completion without checks', function () {
        ...
        $mockStockMoveService->shouldReceive('createMove')->andReturn(new \Jmeryar\Inventory\Models\StockMove);
    ...
    it('triggers blocking check from control point and blocks completion', function () {
        ...
        $qcp = \Jmeryar\QualityControl\Models\QualityControlPoint::factory()->create([
            'company_id' => $this->company->id,
            'trigger_operation' => \Jmeryar\QualityControl\Enums\QualityTriggerOperation::ManufacturingOutput,
            'trigger_frequency' => \Jmeryar\QualityControl\Enums\QualityTriggerFrequency::PerOperation,
            'inspection_template_id' => \Jmeryar\QualityControl\Models\QualityInspectionTemplate::factory()->create(['company_id' => $this->company->id])->id,
            'is_blocking' => true,
            'active' => true,
        ]);
        ...
        app(\Jmeryar\Manufacturing\Services\ManufacturingOrderService::class)->confirm($mo);
        ...
        // 5. Start production
        app(\Jmeryar\Manufacturing\Services\ManufacturingOrderService::class)->startProduction($mo);
