...
class InventoryQualityGateTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $move = StockMove::create([
            ...
            'status' => \Jmeryar\Inventory\Enums\Inventory\StockMoveStatus::Confirmed,
    ...
    private function validatePicking(): void
    {
        ...
        app(\Jmeryar\Inventory\Actions\Inventory\ValidateStockPickingAction::class)->execute($this->picking, $data, false);
    }
}
