...
namespace Jmeryar\QualityControl\Tests\Feature;
...
use Jmeryar\QualityControl\Actions\ResolveQualityAlertAction;
use Jmeryar\QualityControl\DataTransferObjects\ResolveQualityAlertDTO;
...
class QualityAlertResolutionTest extends TestCase
{
    ...
    public function test_triggers_scrap_action_when_resolving_with_scrap(): void
    {
        ...
        $scrapAccount = \Jmeryar\Accounting\Models\Account::factory()->create([
            'company_id' => $this->company->id,
            'type' => 'expense',
        ]);
        ...
        $product = Product::factory()->create([
            'company_id' => $this->company->id,
            'default_inventory_account_id' => \Jmeryar\Accounting\Models\Account::factory()->create(['company_id' => $this->company->id, 'type' => 'current_assets'])->id,
            'default_cogs_account_id' => \Jmeryar\Accounting\Models\Account::factory()->create(['company_id' => $this->company->id, 'type' => 'expense'])->id,
        ]);
