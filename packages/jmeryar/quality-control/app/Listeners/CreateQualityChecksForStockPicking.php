...
namespace Jmeryar\QualityControl\Listeners;

use Jmeryar\Inventory\Enums\Inventory\TrackingType;
use Jmeryar\Inventory\Events\StockPickingValidated;
use Jmeryar\QualityControl\Enums\QualityTriggerOperation;
use Jmeryar\QualityControl\Services\QualityCheckService;
use Jmeryar\QualityControl\Services\QualityControlPointService;
    ...
    public function handle(StockPickingValidated $event): void
    {
        ...
        foreach ($picking->stockMoves as $stockMove) {
            foreach ($stockMove->productLines as $productLine) {
                /** @var \Jmeryar\Product\Models\Product|null $product */
