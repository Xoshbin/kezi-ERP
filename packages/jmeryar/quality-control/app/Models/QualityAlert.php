 ...
 */
#[ObservedBy([AuditLogObserver::class, \Jmeryar\QualityControl\Observers\QualityAlertObserver::class])]
class QualityAlert extends Model
{
    use HasFactory;

    protected static function newFactory(): \Jmeryar\QualityControl\Database\Factories\QualityAlertFactory
    {
        return \Jmeryar\QualityControl\Database\Factories\QualityAlertFactory::new();
    }
