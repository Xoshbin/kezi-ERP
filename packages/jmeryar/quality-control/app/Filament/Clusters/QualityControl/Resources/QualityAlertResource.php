...
use Jmeryar\QualityControl\Filament\Clusters\QualityControl\Resources\QualityAlertResource\Pages;
use Jmeryar\QualityControl\Filament\Clusters\QualityControlCluster;
            ...
            ->actions([
                Action::make('resolve')
                    ...
                    ->action(function (QualityAlert $record, array $data) {
                        app(\Jmeryar\QualityControl\Actions\ResolveQualityAlertAction::class)->execute(
                            new \Jmeryar\QualityControl\DataTransferObjects\ResolveQualityAlertDTO(
