...
it('can pre-fill landed cost from vendor bill', function () {
    ...
    $vendor = \Jmeryar\Foundation\Models\Partner::factory()->create(['company_id' => $company->id]);
    ...
    $url = \Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\LandedCostResource::getUrl('create', [
        'tenant' => $company->id,
