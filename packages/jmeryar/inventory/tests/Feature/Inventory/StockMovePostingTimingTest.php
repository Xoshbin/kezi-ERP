...
use Jmeryar\Inventory\Actions\Inventory\UpdateStockMoveWithProductLinesAction;
...
it('creates journal entries when updating a draft stock move to done', function () {
    ...
    $move = app(\Jmeryar\Inventory\Actions\Inventory\CreateStockMoveAction::class)->execute($createDto);
