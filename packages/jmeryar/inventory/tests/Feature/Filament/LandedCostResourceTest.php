...
use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\LandedCostResource\Pages\CreateLandedCost;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\LandedCostResource\Pages\EditLandedCost;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\LandedCostResource\Pages\ListLandedCosts;
...
beforeEach(function () {
    $currency = \Jmeryar\Foundation\Models\Currency::factory()->create([
        'code' => 'USD',
        'decimal_places' => 2,
    ]);
