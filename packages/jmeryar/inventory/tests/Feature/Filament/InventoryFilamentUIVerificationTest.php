...
use Jmeryar\Inventory\Filament\Clusters\Inventory\Pages\InventoryAgingReport;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Pages\InventoryOverview;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Pages\InventoryTurnoverReport;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Pages\InventoryValuationReport;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Pages\LotTraceabilityReport;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Pages\ReorderStatusReport;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\StockQuantResource\Pages\ListStockQuants;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\StockQuantResource\Pages\ViewStockQuant;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Widgets\InventoryAgingChartWidget;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Widgets\InventoryStatsOverviewWidget;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Widgets\InventoryTurnoverChartWidget;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Widgets\InventoryValueChartWidget;
