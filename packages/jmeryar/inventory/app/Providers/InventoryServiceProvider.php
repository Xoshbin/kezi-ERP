...
class InventoryServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            \Jmeryar\Inventory\Console\Commands\RunReorderingSchedulerCommand::class,
            // \Jmeryar\Inventory\Console\Commands\InventoryPerformanceAnalysis::class, // optional
        ]);
    }
    ...
    public function registerViews(): void
    {
        ...
        Blade::componentNamespace('Jmeryar\\Inventory\\View\\Components', $this->nameLower);
    }
