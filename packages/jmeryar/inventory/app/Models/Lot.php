...
class Lot extends Model
{
    ...
    /**
     * @return HasMany<\Jmeryar\QualityControl\Models\QualityCheck, static>
     */
    public function qualityChecks(): HasMany
    {
        return $this->hasMany(\Jmeryar\QualityControl\Models\QualityCheck::class);
    }

    /**
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo<\Jmeryar\Inventory\Models\StockLocation, static>
     */
    ...
    protected static function newFactory(): \Jmeryar\Inventory\Database\Factories\LotFactory
    {
        return \Jmeryar\Inventory\Database\Factories\LotFactory::new();
    }
}
