...
class StockMoveValuation extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Inventory\Database\Factories\StockMoveValuationFactory
    {
        return \Jmeryar\Inventory\Database\Factories\StockMoveValuationFactory::new();
    }
    ...
    protected $casts = [
        'cost_impact' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
