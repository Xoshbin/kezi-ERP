...
use Jmeryar\Inventory\Database\Factories\AdjustmentDocumentFactory;
 ...
 *
 * @method static \Jmeryar\Inventory\Database\Factories\AdjustmentDocumentFactory factory($count = null, $state = [])
...
class AdjustmentDocument extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Inventory\Database\Factories\AdjustmentDocumentFactory
    {
        return \Jmeryar\Inventory\Database\Factories\AdjustmentDocumentFactory::new();
    }
    ...
    protected $casts = [
        ...
        'subtotal' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,  // Document currency amounts
        ...
        'subtotal_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,  // Company base currency amounts
