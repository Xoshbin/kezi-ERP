...
class InventoryCostLayer extends Model
{
    ...
    protected $casts = [
        ...
        'cost_per_unit' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'purchase_date' => 'date',
    ];
    ...
    protected static function newFactory(): \Jmeryar\Inventory\Database\Factories\InventoryCostLayerFactory
    {
        return \Jmeryar\Inventory\Database\Factories\InventoryCostLayerFactory::new();
    }
}
