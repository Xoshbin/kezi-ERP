...
class ReorderingRule extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Inventory\Database\Factories\ReorderingRuleFactory
    {
        return \Jmeryar\Inventory\Database\Factories\ReorderingRuleFactory::new();
    }
}
