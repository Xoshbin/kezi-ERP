...
use Jmeryar\Inventory\Observers\StockQuantObserver;
...
class StockQuant extends Model
{
    ...
    protected static function newFactory(): \Jmeryar\Inventory\Database\Factories\StockQuantFactory
    {
        return \Jmeryar\Inventory\Database\Factories\StockQuantFactory::new();
    }
}
