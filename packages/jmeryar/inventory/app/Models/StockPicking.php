...
class StockPicking extends Model
{
    ...
    public function hasPendingQualityChecks(): bool
    {
        return $this->qualityChecks()
            ->whereIn('status', [
                \Jmeryar\QualityControl\Enums\QualityCheckStatus::Draft,
                \Jmeryar\QualityControl\Enums\QualityCheckStatus::InProgress,
            ])
            ->exists();
    }
    ...
    protected static function newFactory(): \Jmeryar\Inventory\Database\Factories\StockPickingFactory
    {
        return \Jmeryar\Inventory\Database\Factories\StockPickingFactory::new();
    }
}
