...
namespace Jmeryar\Inventory\Rules\Inventory;

use Closure;
use Illuminate\Contracts\Validation\ValidationRule;
use Jmeryar\Inventory\Enums\Inventory\StockMoveType;
use Jmeryar\Inventory\Services\Inventory\InventoryMovementValidationService;
...
class ValidInventoryMovementRule implements ValidationRule
{
     ...
     */
    public static function incoming(\Jmeryar\Product\Models\Product $product, float $quantity): self
    {
     ...
     */
    public static function outgoing(\Jmeryar\Product\Models\Product $product, float $quantity): self
    {
