...
class ValidateGoodsReceiptAction
{
     ...
     *
     * @param  array<\Jmeryar\Inventory\DataTransferObjects\ReceiveGoodsLineDTO>  $lines
     */
    private function findLineDtoForProductLine(array $lines, StockMoveProductLine $productLine): ?\Jmeryar\Inventory\DataTransferObjects\ReceiveGoodsLineDTO
    {
