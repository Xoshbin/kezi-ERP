        ...
        DB::transaction(function () use ($landedCost) {
            ...
            foreach ($landedCost->lines as $line) {
                ...
                if (in_array($valuationMethod, [ValuationMethod::FIFO, ValuationMethod::LIFO])) {
                    ...
                    /** @var \Illuminate\Database\Eloquent\Collection<int, \Jmeryar\Inventory\Models\InventoryCostLayer> $layers */
                    $layers = \Jmeryar\Inventory\Models\InventoryCostLayer::query()
                        ->where('source_type', \Jmeryar\Inventory\Models\StockMove::class)
