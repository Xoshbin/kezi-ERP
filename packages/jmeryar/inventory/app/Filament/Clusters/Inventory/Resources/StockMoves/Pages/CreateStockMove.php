...
namespace Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\StockMoves\Pages;
...
class CreateStockMove extends CreateRecord
{
    ...
    protected function handleRecordCreation(array $data): Model
    {
        ...
        try {
            return app(\Jmeryar\Inventory\Actions\Inventory\CreateStockMoveAction::class)->execute($dto);
