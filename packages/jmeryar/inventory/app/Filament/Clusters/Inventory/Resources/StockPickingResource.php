...
namespace Jmeryar\Inventory\Filament\Clusters\Inventory\Resources;
...
use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\StockPickingResource\Pages\CreateStockPicking;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\StockPickingResource\Pages\EditStockPicking;
use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\StockPickingResource\Pages\ListStockPickings;
...
class StockPickingResource extends Resource
{
                ...
                ->schema([
                    Forms\Components\Repeater::make('stockMoves')
                        ...
                        ->mutateRelationshipDataBeforeCreateUsing(function (array $data, StockPicking $record): array {
                            ...
                            $data['status'] = \Jmeryar\Inventory\Enums\Inventory\StockMoveStatus::Draft;

                            $data['move_type'] = match ($record->type) {
                                StockPickingType::Receipt => \Jmeryar\Inventory\Enums\Inventory\StockMoveType::Incoming,
                                StockPickingType::Delivery => \Jmeryar\Inventory\Enums\Inventory\StockMoveType::Outgoing,
                                StockPickingType::Internal => \Jmeryar\Inventory\Enums\Inventory\StockMoveType::InternalTransfer,
                                default => \Jmeryar\Inventory\Enums\Inventory\StockMoveType::InternalTransfer,
                            };
                        ...
                        ->schema([
                            ...
                            Forms\Components\Repeater::make('productLines')
                                ...
                                ->schema([
                                    Grid::make(2)
                                        ->schema([
                                            \Xoshbin\TranslatableSelect\Components\TranslatableSelect::forModel('product_id', \Jmeryar\Product\Models\Product::class)
                                                ->label(__('Product'))
                                                ->required()
                                                ->searchable()
                                                ->preload(),
                                    ...
                                    Grid::make(2)
                                        ->schema([
                                            \Xoshbin\TranslatableSelect\Components\TranslatableSelect::forModel('from_location_id', \Jmeryar\Inventory\Models\StockLocation::class)
                                                ->label(__('From Location'))
                                                ->searchable()
                                                ->preload()
                                                ->required(),

                                            \Xoshbin\TranslatableSelect\Components\TranslatableSelect::forModel('to_location_id', \Jmeryar\Inventory\Models\StockLocation::class)
                                ...
                                ->collapsible()
                                ->itemLabel(fn (array $state): ?string => $state['product_id'] ? \Jmeryar\Product\Models\Product::find($state['product_id'])?->name : null)
                                ->deleteAction(fn ($action) => $action->requiresConfirmation())
    ...
    public static function getPages(): array
    {
        return [
            ...
            'validate' => \Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\StockPickingResource\Pages\ValidateStockPicking::route('/{record}/validate'),
        ];
    }
}
