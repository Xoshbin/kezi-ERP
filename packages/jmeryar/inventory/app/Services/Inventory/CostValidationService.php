...
use Jmeryar\Inventory\DataTransferObjects\Inventory\CostPreviewResult;
use Jmeryar\Inventory\DataTransferObjects\Inventory\CostValidationResult;
...
class CostValidationService
{
    ...
    public function getSuggestedActions(Product $product): array
    {
        ...
        $analysisService = app(\Jmeryar\Inventory\Services\Inventory\ProductCostAnalysisService::class);
