...
{
    protected $model = \Jmeryar\Inventory\Models\AdjustmentDocument::class;
    ...
    {
        return $this->afterCreating(function (\Jmeryar\Inventory\Models\AdjustmentDocument $adjustmentDocument) use ($count) {
