    ...
    @if(empty($costLayers))
        <div class="text-center py-8">
            ...
            <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">
                {{ __('inventory::inventory_reports.valuation.cost_layers_modal.no_layers') }}
            </h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ __('inventory::inventory_reports.valuation.cost_layers_modal.no_layers_description') }}
            </p>
        </div>
    @else
                ...
                <thead class="bg-gray-50 dark:bg-gray-800">
                    <tr>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                            {{ __('inventory::inventory_reports.valuation.cost_layers_modal.purchase_date') }}
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                            {{ __('inventory::inventory_reports.valuation.cost_layers_modal.quantity') }}
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                            {{ __('inventory::inventory_reports.valuation.cost_layers_modal.cost_per_unit') }}
                        </th>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                            {{ __('inventory::inventory_reports.valuation.cost_layers_modal.total_value') }}
                        </th>
                    </tr>
                </thead>
                ...
                <tfoot class="bg-gray-50 dark:bg-gray-800">
                    <tr>
                        <th scope="row" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                            {{ __('inventory::inventory_reports.valuation.cost_layers_modal.total') }}
                        </th>
                        ...
                        <td class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400">
                            {{ __('inventory::inventory_reports.valuation.cost_layers_modal.weighted_avg') }}
                        </td>
                        <td class="px-6 py-3 text-left text-xs font-medium text-gray-900 dark:text-white">
                            @php
