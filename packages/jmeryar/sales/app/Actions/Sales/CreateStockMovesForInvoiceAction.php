...
class CreateStockMovesForInvoiceAction
{
    public function __construct(
        protected \Jmeryar\Inventory\Actions\Inventory\CreateStockMoveAction $createStockMoveAction,
    ) {}
    ...
    public function execute(CreateStockMovesForInvoiceDTO $dto): Collection
    {
        return DB::transaction(function () use ($dto) {
            ...
            $storableLines = $invoice->invoiceLines->filter(fn ($line) => $line->product && $line->product->type === \Jmeryar\Product\Enums\Products\ProductType::Storable
            );
            ...
            foreach ($invoice->invoiceLines as $line) {
                if ($line->product && $line->product->type === \Jmeryar\Product\Enums\Products\ProductType::Storable) {
