...
use Jmeryar\Sales\DataTransferObjects\Sales\SalesOrderLineDTO;
            ...
            Actions\Action::make('create_invoice')
                ...
                ->form([
                    ...
                    \Filament\Forms\Components\Select::make('default_income_account_id')
                        ...
                        ->options(\Jmeryar\Accounting\Models\Account::pluck('name', 'id'))
                        ->searchable()
                        ->required(),
                ])
                ->action(function (SalesOrder $record, array $data) {
                    $dto = new \Jmeryar\Sales\DataTransferObjects\Sales\CreateInvoiceFromSalesOrderDTO(
                        salesOrder: $record,
                    ...
                    app(\Jmeryar\Sales\Actions\Sales\CreateInvoiceFromSalesOrderAction::class)->execute($dto);
