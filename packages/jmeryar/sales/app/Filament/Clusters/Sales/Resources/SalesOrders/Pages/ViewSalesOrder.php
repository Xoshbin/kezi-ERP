    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Action::make('confirm')
                ...
                ->action(function () {
                    app(\Jmeryar\Sales\Actions\Sales\ConfirmSalesOrderAction::class)->execute($this->record, auth()->user());
                ...
                ->visible(fn () => $this->record->status === \Jmeryar\Sales\Enums\Sales\SalesOrderStatus::Draft),
