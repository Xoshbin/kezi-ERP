...
use Jmeryar\Accounting\Actions\Accounting\BuildInvoicePostingPreviewAction;
...
class InvoiceService
{
    ...
    public function delete(Invoice $invoice): bool
    {
        ...
        if ($invoice->status !== InvoiceStatus::Draft) {
            throw new \Jmeryar\Foundation\Exceptions\DeletionNotAllowedException('Cannot delete a posted invoice.');
        }
