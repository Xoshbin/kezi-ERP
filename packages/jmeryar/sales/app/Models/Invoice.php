...
use Jmeryar\Foundation\Models\Concerns\HasDocumentAttachments;
 ...
 * @method static \Jmeryar\Sales\Database\Factories\InvoiceFactory factory($count = null, $state = [])
...
class Invoice extends Model
{
    ...
    protected $casts = [
        ...
        'total_amount' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'total_tax' => \Jmeryar\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'total_amount_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'total_tax_company_currency' => \Jmeryar\Foundation\Casts\BaseCurrencyMoneyCast::class,
    ...
    */
    ...
    /**
     * @return BelongsTo<\Jmeryar\Accounting\Models\DunningLevel, static>
     */
    public function dunningLevel(): BelongsTo
    {
        return $this->belongsTo(\Jmeryar\Accounting\Models\DunningLevel::class);
    }
    ...
    */
    ...
    protected static function newFactory(): \Jmeryar\Sales\Database\Factories\InvoiceFactory
    {
        return \Jmeryar\Sales\Database\Factories\InvoiceFactory::new();
    }
}
