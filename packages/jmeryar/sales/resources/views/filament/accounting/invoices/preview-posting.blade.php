@php use Jmeryar\Inventory\Filament\Clusters\Inventory\Resources\Products\ProductResource; @endphp
@php use Jmeryar\Foundation\Filament\Resources\Accounts\AccountResource; @endphp
@php use Jmeryar\Foundation\Filament\Resources\Companies\CompanyResource; @endphp
@php use Jmeryar\Foundation\Filament\Resources\Taxes\TaxResource; @endphp
@php use Jmeryar\Foundation\Support\TranslatableHelper; @endphp
<div>
                    ...
                    <li>
                        ...
                        @elseif($t === 'tax_account_missing')
                            <a href="{{ TaxResource::getUrl() }}" class="ml-2 underline"
                               target="_blank">{{ __('posting_preview.links.open_taxes') }}</a>
