...
it('can create an invoice from a confirmed sales order', function () {
    $currency = \Jmeryar\Foundation\Models\Currency::where('code', 'USD')->first() ?? \Jmeryar\Foundation\Models\Currency::factory()->create(['code' => 'USD']);

    $customer = \Jmeryar\Foundation\Models\Partner::factory()->create([
    ...
    expect($invoice)->toBeInstanceOf(\Jmeryar\Sales\Models\Invoice::class)
