...
namespace Jmeryar\Sales\Tests\Feature\Filament\Flows;
...
class SalesOrderAccountingFlowTest extends TestCase
{
    ...
    public function test_sales_order_full_accounting_flow()
    {
        ...
        Livewire::test(\Jmeryar\Accounting\Filament\Clusters\Accounting\Resources\Invoices\Pages\ViewInvoice::class, ['record' => $invoice->id])
        ...
        // Verify Payment JE
        $paymentJE = JournalEntry::where('source_type', 'Jmeryar\Payment\Models\Payment')
            ->latest('id')
            ->first();
