...
use Jmeryar\Foundation\Database\Factories\PartnerFactory;
 ...
 * @property \Jmeryar\Foundation\Enums\Partners\PartnerType $type
 ...
 * @property-read \Jmeryar\Accounting\Models\FiscalPosition|null $fiscalPosition
 * @property-read \Jmeryar\Accounting\Models\Tax|null $defaultTax
 *
 * @method static \Jmeryar\Foundation\Database\Factories\PartnerFactory factory($count = null, $state = [])
 ...
 * @mixin Eloquent
 */
#[ObservedBy([\Jmeryar\Foundation\Observers\PartnerObserver::class])]
class Partner extends Model
{
    ...
    {
        return \Jmeryar\Foundation\Database\Factories\PartnerFactory::new();
    }
     ...
     */
    protected $casts = [
        'type' => \Jmeryar\Foundation\Enums\Partners\PartnerType::class,
        'is_active' => 'boolean',
        'created_at' => 'datetime',
        'updated_at' => 'datetime',
        'deleted_at' => 'datetime',
    ...
    */
    ...
    {
        return $this->belongsTo(\Jmeryar\Accounting\Models\WithholdingTaxType::class, 'withholding_tax_type_id');
    }
    ...
    {
        return $this->belongsTo(\Jmeryar\Accounting\Models\FiscalPosition::class, 'fiscal_position_id');
    }
    ...
    {
        return $this->belongsTo(\Jmeryar\Accounting\Models\Tax::class, 'default_tax_id');
    }
    ...
    {
        if (! in_array($this->type, [\Jmeryar\Foundation\Enums\Partners\PartnerType::Customer, \Jmeryar\Foundation\Enums\Partners\PartnerType::Both])) {
    ...
    {
        if (! in_array($this->type, [\Jmeryar\Foundation\Enums\Partners\PartnerType::Vendor, \Jmeryar\Foundation\Enums\Partners\PartnerType::Both])) {
            $this->loadMissing('company.currency');
    ...
    */
    ...
    public function getVendorDueWithinDays(int $days): Money
    {
        ...
        /** @var Collection<int, VendorBill> $dueBills */
