...
namespace Jmeryar\Foundation\Traits;

use Brick\Money\Money;
use Exception;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Support\Facades\Log;
use Jmeryar\Foundation\Models\PaymentDocumentLink;
...
trait HasPaymentState
{
     ...
     */
    public function getPaymentStateAttribute(): \Jmeryar\Foundation\Enums\Shared\PaymentState
    {
        $paidAmount = $this->getPaidAmount();

        if ($paidAmount->isZero()) {
            return \Jmeryar\Foundation\Enums\Shared\PaymentState::NotPaid;
        }

        // isGreaterThanOrEqual() handles cases of overpayment correctly.
        if ($paidAmount->isGreaterThanOrEqualTo($this->total_amount)) {
            return \Jmeryar\Foundation\Enums\Shared\PaymentState::Paid;
        }

        return \Jmeryar\Foundation\Enums\Shared\PaymentState::PartiallyPaid;
    }
    ...
    public function getPaidAmount(): Money
    {
        ...
        $currencyConverter = app(\Jmeryar\Foundation\Services\CurrencyConverterService::class);
    ...
    {
        return $this->payment_state === \Jmeryar\Foundation\Enums\Shared\PaymentState::Paid;
    }
    ...
    {
        return $this->payment_state === \Jmeryar\Foundation\Enums\Shared\PaymentState::PartiallyPaid;
    }
    ...
    {
        return $this->payment_state === \Jmeryar\Foundation\Enums\Shared\PaymentState::NotPaid;
    }
}
