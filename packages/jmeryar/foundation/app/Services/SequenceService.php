...
namespace Jmeryar\Foundation\Services;
...
class SequenceService
{
    ...
    public function getNextInvoiceNumber(Company $company, ?Carbon $date = null): string
    {
        ...
        $numberingType = \Jmeryar\Foundation\Enums\Settings\NumberingType::from($config['type']);
        ...
        if ($numberingType === \Jmeryar\Foundation\Enums\Settings\NumberingType::SIMPLE) {
            return $nextNumber;
        }
