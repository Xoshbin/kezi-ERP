...
namespace Jmeryar\Foundation\Enums;
...
enum Incoterm: string implements HasDescription, HasLabel
{
    ...
    public function getCostResponsibilities(): \Jmeryar\Foundation\DataTransferObjects\ShippingCostResponsibilityDTO
    {
        return new \Jmeryar\Foundation\DataTransferObjects\ShippingCostResponsibilityDTO(
