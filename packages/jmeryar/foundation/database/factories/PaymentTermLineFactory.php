...
use Jmeryar\Foundation\Models\PaymentTermLine;

/**
 * @extends Factory<\Jmeryar\Foundation\Models\PaymentTermLine>
 */
class PaymentTermLineFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'sequence' => 1,
            'type' => $this->faker->randomElement(\Jmeryar\Foundation\Enums\PaymentTerms\PaymentTermType::cases()),
    ...
    public function immediate(): static
    {
        return $this->state(fn (array $attributes) => [
            'type' => \Jmeryar\Foundation\Enums\PaymentTerms\PaymentTermType::Immediate,
            'days' => 0,
            'percentage' => 100.0,
        ]);
    }
    ...
    {
        return $this->state(fn (array $attributes) => [
            'type' => \Jmeryar\Foundation\Enums\PaymentTerms\PaymentTermType::Net,
            'days' => $days,
            'percentage' => 100.0,
        ]);
    }
    ...
    {
        return $this->state(fn (array $attributes) => [
            'type' => \Jmeryar\Foundation\Enums\PaymentTerms\PaymentTermType::EndOfMonth,
            'days' => $additionalDays,
            'percentage' => 100.0,
        ]);
    }
    ...
    {
        return $this->state(fn (array $attributes) => [
            'type' => \Jmeryar\Foundation\Enums\PaymentTerms\PaymentTermType::DayOfMonth,
            'days' => $additionalDays,
