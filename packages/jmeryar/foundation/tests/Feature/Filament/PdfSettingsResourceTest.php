...
use Jmeryar\Foundation\Filament\Resources\PdfSettings\Pages\EditPdfSettings;
use Jmeryar\Foundation\Filament\Resources\PdfSettings\Pages\ListPdfSettings;
use Jmeryar\Foundation\Filament\Resources\PdfSettings\PdfSettingsResource;
...
test('pdf settings resource shows correct navigation label', function () {
    // Assert
    expect(PdfSettingsResource::getNavigationLabel())->toBe(__('foundation::pdf_settings.navigation_label'));
    expect(PdfSettingsResource::getModelLabel())->toBe(__('foundation::pdf_settings.model_label'));
    expect(PdfSettingsResource::getPluralModelLabel())->toBe(__('foundation::pdf_settings.model_plural_label'));
});
