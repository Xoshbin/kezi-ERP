...
describe('SequenceService', function () {
    ...
    beforeEach(function () {
        ...
        $this->sequenceService = app(\Jmeryar\Foundation\Services\SequenceService::class);
    });
    ...
    it('generates invoice numbers using company settings', function () {
        ...
        $this->company->numbering_settings = [
            'invoice' => [
                'type' => \Jmeryar\Foundation\Enums\Settings\NumberingType::SIMPLE->value,
                'prefix' => 'INVOICE',
                'padding' => 6,
            ],
        ];
    ...
    it('generates numbers with year month format', function () {
        $this->company->numbering_settings = [
            'vendor_bill' => [
                'type' => \Jmeryar\Foundation\Enums\Settings\NumberingType::YEAR_MONTH->value,
                'prefix' => 'BILL',
                'padding' => 3,
            ],
        ];
