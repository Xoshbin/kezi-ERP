...
class PettyCashFund extends Model
{
    ...
    {
        return \Kezi\Payment\Database\Factories\PettyCash\PettyCashFundFactory::new();
    }
    ...
    protected $casts = [
        'imprest_amount' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'current_balance' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,
