...
use Kezi\Payment\Observers\PaymentObserver;
...
class Payment extends Model
{
    ...
    protected $casts = [
        ...
        'amount' => \Kezi\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Payment amount in payment currency
        'amount_company_currency' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class, // Payment amount in company base currency
     ...
     *
     * @return HasMany<\Kezi\Accounting\Models\WithholdingTaxEntry, static>
     */
    public function withholdingTaxEntries(): HasMany
    {
        return $this->hasMany(\Kezi\Accounting\Models\WithholdingTaxEntry::class);
    }
    ...
    protected static function newFactory(): \Kezi\Payment\Database\Factories\PaymentFactory
    {
        return \Kezi\Payment\Database\Factories\PaymentFactory::new();
    }
}
