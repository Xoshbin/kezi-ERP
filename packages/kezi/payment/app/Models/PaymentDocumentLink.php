...
class PaymentDocumentLink extends Pivot
{
     ...
     */
    protected $casts = [
        'amount_applied' => \Kezi\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Amount in payment currency
    ...
    protected static function newFactory(): \Kezi\Payment\Database\Factories\PaymentDocumentLinkFactory
    {
        return \Kezi\Payment\Database\Factories\PaymentDocumentLinkFactory::new();
    }
}
