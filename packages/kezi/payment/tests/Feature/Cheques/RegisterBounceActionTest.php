...
use Kezi\Payment\Models\ChequeBouncedLog;
...
it('can register a bounce for deposited cheque', function () {
    ...
    $journalEntry = \Kezi\Accounting\Models\JournalEntry::factory()->create(['company_id' => $company->id]);
    ...
    $cheque = Cheque::factory()->receivable()->create([
        ...
        'partner_id' => \Kezi\Foundation\Models\Partner::factory()->create(['company_id' => $company->id])->id,
    ]);
