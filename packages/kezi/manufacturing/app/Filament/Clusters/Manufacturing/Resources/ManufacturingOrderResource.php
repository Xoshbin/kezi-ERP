...
use Kezi\Manufacturing\Filament\Clusters\Manufacturing\ManufacturingCluster;
                ...
                ->schema([
                    ...
                    Forms\Components\Select::make('bom_id')
                        ...
                        ->afterStateUpdated(function ($state, callable $set) {
                            if ($state) {
                                $bom = \Kezi\Manufacturing\Models\BillOfMaterial::find($state);
                                if ($bom) {
            ...
            ->actions([
                ...
                FilamentAction::make('cancel')
                    ...
                    ->action(function (ManufacturingOrder $record) {
                        try {
                            app(\Kezi\Manufacturing\Services\ManufacturingOrderService::class)->cancel($record);
