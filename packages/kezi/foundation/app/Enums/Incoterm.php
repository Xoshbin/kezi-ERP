...
enum Incoterm: string implements HasDescription, HasLabel
{
    ...
    public function getCostResponsibilities(): \Kezi\Foundation\DataTransferObjects\ShippingCostResponsibilityDTO
    {
        return new \Kezi\Foundation\DataTransferObjects\ShippingCostResponsibilityDTO(
