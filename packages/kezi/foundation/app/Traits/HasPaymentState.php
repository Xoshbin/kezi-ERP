...
namespace Kezi\Foundation\Traits;

use Brick\Money\Money;
use Exception;
use Illuminate\Database\Eloquent\Collection;
use Illuminate\Support\Facades\Log;
use Kezi\Foundation\Models\PaymentDocumentLink;
...
trait HasPaymentState
{
     ...
     */
    public function getPaymentStateAttribute(): \Kezi\Foundation\Enums\Shared\PaymentState
    {
        $paidAmount = $this->getPaidAmount();

        if ($paidAmount->isZero()) {
            return \Kezi\Foundation\Enums\Shared\PaymentState::NotPaid;
        }

        // isGreaterThanOrEqual() handles cases of overpayment correctly.
        if ($paidAmount->isGreaterThanOrEqualTo($this->total_amount)) {
            return \Kezi\Foundation\Enums\Shared\PaymentState::Paid;
        }

        return \Kezi\Foundation\Enums\Shared\PaymentState::PartiallyPaid;
    }
    ...
    {
        return $this->payment_state === \Kezi\Foundation\Enums\Shared\PaymentState::Paid;
    }
    ...
    {
        return $this->payment_state === \Kezi\Foundation\Enums\Shared\PaymentState::PartiallyPaid;
    }
    ...
    {
        return $this->payment_state === \Kezi\Foundation\Enums\Shared\PaymentState::NotPaid;
    }
}
