...
use Kezi\Foundation\Database\Factories\PartnerFactory;
 ...
 * @property \Kezi\Foundation\Enums\Partners\PartnerType $type
 ...
 * @mixin Eloquent
 */
#[ObservedBy([\Kezi\Foundation\Observers\PartnerObserver::class])]
class Partner extends Model
{
    ...
    {
        return \Kezi\Foundation\Database\Factories\PartnerFactory::new();
    }
     ...
     */
    protected $casts = [
        'type' => \Kezi\Foundation\Enums\Partners\PartnerType::class,
        'is_active' => 'boolean',
        'created_at' => 'datetime',
        'updated_at' => 'datetime',
        'deleted_at' => 'datetime',
    ...
    */
    ...
    {
        return $this->belongsTo(\Kezi\Accounting\Models\WithholdingTaxType::class, 'withholding_tax_type_id');
    }
    ...
    {
        return $this->belongsTo(\Kezi\Accounting\Models\FiscalPosition::class, 'fiscal_position_id');
    }
    ...
    {
        return $this->belongsTo(\Kezi\Accounting\Models\Tax::class, 'default_tax_id');
    }
    ...
    {
        if (! in_array($this->type, [\Kezi\Foundation\Enums\Partners\PartnerType::Customer, \Kezi\Foundation\Enums\Partners\PartnerType::Both])) {
    ...
    {
        if (! in_array($this->type, [\Kezi\Foundation\Enums\Partners\PartnerType::Vendor, \Kezi\Foundation\Enums\Partners\PartnerType::Both])) {
            $this->loadMissing('company.currency');
