 ...
 * @property \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType $type
 * @property int $days
...
class PaymentTermLine extends Model
{
    ...
    protected static function newFactory(): \Kezi\Foundation\Database\Factories\PaymentTermLineFactory
    {
        return \Kezi\Foundation\Database\Factories\PaymentTermLineFactory::new();
    }
     ...
     */
    protected $casts = [
        'type' => \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::class,
        'percentage' => 'float',
    ...
    public function calculateDueDate(Carbon $documentDate): Carbon
    {
        return match ($this->type) {
            \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::Net => $documentDate->copy()->addDays($this->days),
            \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::EndOfMonth => $this->calculateEndOfMonthDate($documentDate),
            \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::DayOfMonth => $this->calculateDayOfMonthDate($documentDate),
            \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::Immediate => $documentDate->copy(),
        };
    }
    ...
    public function getDescription(): string
    {
        $description = match ($this->type) {
            \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::Immediate => __('foundation::payment_terms.immediate'),
            \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::Net => __('foundation::payment_terms.net_days', ['days' => $this->days]),
            \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::EndOfMonth => $this->days > 0
                ? __('foundation::payment_terms.end_of_month_plus_days', ['days' => $this->days])
                : __('foundation::payment_terms.end_of_month'),
            \Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::DayOfMonth => __('foundation::payment_terms.day_of_month', [
