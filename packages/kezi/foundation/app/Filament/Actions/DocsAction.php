...
class DocsAction
{
    ...
    private static function mapSlugToDocumentationPath(string $slug): string
    {
        $mapping = [
            ...
            'timesheet-tracking' => 'how-to/track-timesheets',
            'track-timesheets' => 'how-to/track-timesheets',
            'project-lifecycle' => 'tutorials/project-lifecycle',
            'project-concepts' => 'explanation/project-concepts',
            'project-architecture' => 'explanation/project-architecture',
            'project-fields-and-statuses' => 'reference/project-fields-and-statuses',
