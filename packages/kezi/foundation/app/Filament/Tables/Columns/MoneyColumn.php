...
namespace Kezi\Foundation\Filament\Tables\Columns;
    ...
    protected function setUp(): void
    {
        ...
        $this->formatStateUsing(function ($state, ?Model $record): ?string {
            ...
            if ($state instanceof Money) {
                return \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo($state);
            }
            ...
            if (is_numeric($state) && $record) {
                ...
                if ($money instanceof Money) {
                    return \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo($money);
                }
            }
