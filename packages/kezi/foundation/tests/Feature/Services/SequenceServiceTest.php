...
use Carbon\Carbon;
use Kezi\Foundation\Models\Sequence;
...
describe('SequenceService', function () {
    ...
    it('generates invoice numbers using company settings', function () {
        ...
        $this->company->numbering_settings = [
            'invoice' => [
                'type' => \Kezi\Foundation\Enums\Settings\NumberingType::SIMPLE->value,
                'prefix' => 'INVOICE',
                'padding' => 6,
            ],
        ];
    ...
    it('generates numbers with year month format', function () {
        $this->company->numbering_settings = [
            'vendor_bill' => [
                'type' => \Kezi\Foundation\Enums\Settings\NumberingType::YEAR_MONTH->value,
                'prefix' => 'BILL',
                'padding' => 3,
            ],
        ];
