...
use Kezi\Foundation\Database\Seeders\PaymentTermsSeeder;
...
it('creates correct payment term lines for immediate payment', function () {
    ...
    expect($line->type)->toBe(\Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::Immediate);
...
it('creates correct payment term lines for net 30', function () {
    ...
    $line = $lines->first();
    expect($line->sequence)->toBe(1);
    expect($line->type)->toBe(\Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::Net);
...
it('creates correct payment term lines for installment payments', function () {
    ...
    expect($firstLine->type)->toBe(\Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::Immediate);
    ...
    expect($secondLine->type)->toBe(\Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::Net);
...
it('creates correct payment term lines for day of month', function () {
    ...
    $line = $lines->first();
    expect($line->sequence)->toBe(1);
    expect($line->type)->toBe(\Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::DayOfMonth);
    expect($line->days)->toBe(0);
...
it('creates correct payment term lines for end of month', function () {
    ...
    $line = $lines->first();
    expect($line->sequence)->toBe(1);
    expect($line->type)->toBe(\Kezi\Foundation\Enums\PaymentTerms\PaymentTermType::EndOfMonth);
