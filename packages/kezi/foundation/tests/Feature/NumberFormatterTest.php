...
it('formats money with English locale by default', function () {
    ...
    $formatted = \Kezi\Foundation\Support\NumberFormatter::formatMoney($money);
...
it('formats money using formatMoneyTo with configured locale', function () {
    ...
    $formatted = \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo($money);
...
it('formats numbers with English locale by default', function () {
    $formatted = \Kezi\Foundation\Support\NumberFormatter::formatNumber(1234.56);
...
it('formats percentages with English locale by default', function () {
    $formatted = \Kezi\Foundation\Support\NumberFormatter::formatPercentage(25.5);
...
it('respects auto locale setting', function () {
    ...
    $locale = \Kezi\Foundation\Support\NumberFormatter::getNumberLocale();
