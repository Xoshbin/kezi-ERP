...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
        <a href="{{ route('filament.kezi.accounting.resources.vendor-bills.create', ['tenant' => Filament::getTenant()]) }}"
           target="_blank"
        ...
        <a href="{{ route('filament.kezi.accounting.resources.vendor-bills.index', ['tenant' => Filament::getTenant()]) }}"
           target="_blank"
