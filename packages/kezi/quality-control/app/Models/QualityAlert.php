...
class QualityAlert extends Model
{
    ...
    protected static function newFactory(): \Kezi\QualityControl\Database\Factories\QualityAlertFactory
    {
        return \Kezi\QualityControl\Database\Factories\QualityAlertFactory::new();
    }
