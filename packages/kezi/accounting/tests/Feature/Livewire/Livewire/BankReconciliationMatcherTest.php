...
describe('BankReconciliationMatcher Livewire Component', function () {
    it('can mount with bank statement ID', function () {
        Livewire::test(\Kezi\Accounting\Livewire\Accounting\BankReconciliationMatcher::class, ['bankStatementId' => $this->bankStatement->id])
    ...
    it('calculates summary correctly for balanced selection', function () {
        ...
        $component = Livewire::test(\Kezi\Accounting\Livewire\Accounting\BankReconciliationMatcher::class, ['bankStatementId' => $this->bankStatement->id]);
...
describe('Multi-Currency Livewire Reconciliation', function () {
    ...
    it('handles USD bank statement with USD payment reconciliation', function () {
        ...
        $component = Livewire::test(\Kezi\Accounting\Livewire\Accounting\BankReconciliationMatcher::class, ['bankStatementId' => $this->usdBankStatement->id]);
