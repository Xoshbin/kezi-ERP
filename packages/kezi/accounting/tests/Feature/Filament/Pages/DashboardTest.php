...
namespace Kezi\Accounting\Tests\Feature\Filament\Pages;

use App\Models\User;
use Filament\Facades\Filament;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Kezi\Accounting\Filament\Clusters\Accounting\Pages\Dashboard;
...
it('includes all financial widgets', function () {
    ...
    $this->get(Dashboard::getUrl())
        ->assertSuccessful()
        ->assertSeeLivewire(\Kezi\Accounting\Filament\Clusters\Accounting\Widgets\FinancialStatsOverview::class)
        ->assertSeeLivewire(\Kezi\Accounting\Filament\Clusters\Accounting\Widgets\IncomeVsExpenseChart::class)
        ->assertSeeLivewire(\Kezi\Accounting\Filament\Clusters\Accounting\Widgets\CashFlowWidget::class);
});
