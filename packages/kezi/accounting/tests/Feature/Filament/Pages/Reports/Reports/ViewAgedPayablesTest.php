...
test('it can generate aged payables report', function () {
    ...
    // Action & Assert
    $expectedAmount = \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(1000, $currency));
    Livewire::test(ViewAgedPayables::class)
        ->fillForm([
...
test('it displays correct aging buckets', function () {
    ...
    // Action & Assert
    $amount1 = \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(1000, $currency));
    $amount2 = \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(2000, $currency));
    $amount3 = \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(3000, $currency));
    $total = \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo(Money::of(6000, $currency));
