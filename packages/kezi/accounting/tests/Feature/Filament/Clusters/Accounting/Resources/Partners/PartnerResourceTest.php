...
namespace Kezi\Accounting\Tests\Feature\Filament\Clusters\Accounting\Resources\Partners;
...
it('can edit a partner to set/change default_tax_id', function () {
    $oldTax = \Kezi\Accounting\Models\Tax::factory()->for($this->company)->create([
        'name' => 'Old Tax',
        'rate' => 0.10,
        'is_active' => true,
    ]);

    $newTax = \Kezi\Accounting\Models\Tax::factory()->for($this->company)->create([
        'name' => 'New Tax',
        'rate' => 0.15,
        'is_active' => true,
    ]);
