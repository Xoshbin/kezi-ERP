...
it('handles unclosed previous year by simulating P&L closure and preserving partner grouping', function () {
    ...
    // 3. Setup Partners
    $partnerA = \Kezi\Foundation\Models\Partner::factory()->create(['company_id' => $this->company->id, 'name' => 'Customer A']);
    $partnerB = \Kezi\Foundation\Models\Partner::factory()->create(['company_id' => $this->company->id, 'name' => 'Customer B']);
