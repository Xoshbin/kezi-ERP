...
beforeEach(function () {
    ...
    $this->vendor = Partner::factory()->for($this->company)->create(['type' => \Kezi\Foundation\Enums\Partners\PartnerType::Vendor]);
    $this->customer = Partner::factory()->for($this->company)->create(['type' => \Kezi\Foundation\Enums\Partners\PartnerType::Customer]);
    ...
    $this->product = Product::factory()->for($this->company)->create([
        'type' => \Kezi\Product\Enums\Products\ProductType::Service, // Use service type to avoid inventory movements
