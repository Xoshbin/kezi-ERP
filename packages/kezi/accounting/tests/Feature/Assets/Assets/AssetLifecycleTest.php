...
use Kezi\Foundation\Exceptions\DeletionNotAllowedException;
use Kezi\Foundation\Exceptions\UpdateNotAllowedException;
...
test('automated depreciation job posts correct journal entries periodically', function () {
    ...
    $this->assertDatabaseHas('depreciation_entries', [
        'asset_id' => $asset->id,
        'status' => DepreciationEntryStatus::Posted->value,
    ]);
