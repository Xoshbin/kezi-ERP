            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
                <div class="mb-6">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
                        {{ __('accounting::reports.partner_ledger') }}
                    </h2>
                ...
                @if(count($reportData['transactionLines']) > 0)
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                                ...
                                                @elseif($line['transactionType'] === 'Vendor Bill') bg-amber-100 text-amber-800 dark:bg-amber-900/20 dark:text-amber-400
                    ...
                    <div class="mt-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                        ...
                        @else
                            <p class="text-xs text-green-700 dark:text-green-300 mt-1">
                                {{ __('accounting::reports.account_balanced') }}
                            </p>
                        @endif
                    </div>
                @else
                    <div class="text-center py-8">
                        <div class="text-gray-400 dark:text-gray-500 mb-4">
                            ...
                            <h3 class="text-lg font-medium mb-2">{{ __('accounting::reports.no_transactions') }}</h3>
                            <p class="text-sm">{{ __('accounting::reports.no_transactions_found_for_period') }}</p>
                        </div>
                    </div>
                @endif
            </div>
        @else
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 text-center">
                ...
                <p class="text-gray-600 dark:text-gray-400">
                    {{ __('accounting::reports.select_partner_and_generate') }}
                </p>
            </div>
        @endif
    </div>
