...
use Kezi\Accounting\Actions\Assets\DisposeAssetAction;
use Kezi\Accounting\Actions\Assets\PostDepreciationEntryAction;
use Kezi\Accounting\Actions\Assets\UpdateAssetAction;
use Kezi\Accounting\DataTransferObjects\Assets\DisposeAssetDTO;
...
class AssetService
{
    ...
    public function createAsset(\Kezi\Accounting\DataTransferObjects\Assets\CreateAssetDTO $dto): Asset
    {
     ...
     *
     * @throws \Kezi\Foundation\Exceptions\DeletionNotAllowedException If the asset cannot be deleted due to business rules.
     */
    ...
    public function computeDepreciation(Asset $asset): Collection
    {
        ...
        return match ($asset->depreciation_method) {
            \Kezi\Accounting\Enums\Assets\DepreciationMethod::Declining => $this->computeDecliningBalance($asset),
            \Kezi\Accounting\Enums\Assets\DepreciationMethod::SumOfDigits => $this->computeSumOfDigits($asset),
