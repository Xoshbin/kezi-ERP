...
namespace Kezi\Accounting\Services\Consolidation;
    ...
    public function identifyInterCompanyBalances(array $companyIds, Carbon $date): array
    {
        return JournalEntryLine::query()
            ...
            ->whereHas('account', function ($query) {
                $query->whereIn('type', [
                    \Kezi\Accounting\Enums\Accounting\AccountType::Receivable,
                    \Kezi\Accounting\Enums\Accounting\AccountType::Payable,
                ]);
            })
            // Partner Link Check
