...
use Carbon\Carbon;
use Kezi\Accounting\DataTransferObjects\Reports\Consolidation\ConsolidatedTrialBalanceDTO;
...
use Kezi\Accounting\Services\Reports\TrialBalanceService;
    ...
    public function generate(Company $parentCompany, Carbon $asOfDate): ConsolidatedTrialBalanceDTO
    {
        ...
        foreach ($companies as $company) {
            ...
            foreach ($tb->reportLines as $line) {
                ...
                $method = match ($line->accountType) {
                    \Kezi\Accounting\Enums\Accounting\AccountType::Income,
                    \Kezi\Accounting\Enums\Accounting\AccountType::Expense => \Kezi\Accounting\Enums\Consolidation\CurrencyTranslationMethod::AverageRate,
                    default => \Kezi\Accounting\Enums\Consolidation\CurrencyTranslationMethod::ClosingRate,
                };
        ...
        foreach ($eliminationLines as $jeLine) {
            ...
            $convertedDebitElim = $this->currencyTranslationService->translate(
                ...
                $parentCompany->currency,
                $asOfDate,
                \Kezi\Accounting\Enums\Consolidation\CurrencyTranslationMethod::ClosingRate, // Balances are usually Closing
                $parentCompany
            );
            ...
            $convertedCreditElim = $this->currencyTranslationService->translate(
                ...
                $parentCompany->currency,
                $asOfDate,
                \Kezi\Accounting\Enums\Consolidation\CurrencyTranslationMethod::ClosingRate,
                $parentCompany
            );
