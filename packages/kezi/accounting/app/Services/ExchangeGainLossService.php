...
class ExchangeGainLossService
{
    ...
    protected function postRealizedGainLossEntry(
        ...
        return app(\Kezi\Accounting\Actions\Accounting\CreateJournalEntryAction::class)->execute($entryDTO);
    }
     ...
     * @return \Illuminate\Database\Eloquent\Collection<int, \Kezi\Accounting\Models\Account>
     */
     ...
     */
    protected function getForeignCurrencyBalances(\Kezi\Accounting\Models\Account $account, Carbon $date): array
    {
    ...
    protected function postUnrealizedGainLossEntry(
        Company $company,
        \Kezi\Accounting\Models\Account $account,
        Currency $currency,
