...
class BankReconciliationMatcher extends Component
{
    ...
    public function summary(): array
    {
        ...
        return [
            ...
            'bankTotalFormatted' => \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo($this->bankTotal),
            'systemTotalFormatted' => \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo($this->systemTotal),
            'differenceFormatted' => \Kezi\Foundation\Support\NumberFormatter::formatMoneyTo($difference),
        ];
    }
