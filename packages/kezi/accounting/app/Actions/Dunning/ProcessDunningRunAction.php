...
class ProcessDunningRunAction
{
    public function __construct(
        private readonly \Kezi\Sales\Actions\Sales\CreateInvoiceAction $createInvoiceAction,
    ) {}
    ...
    private function createDebitNote(Invoice $invoice, DunningLevel $level): void
    {
        ...
        $lineDto = new \Kezi\Sales\DataTransferObjects\Sales\CreateInvoiceLineDTO(
