...
class BankStatementLine extends Model
{
    ...
    {
        return \Kezi\Accounting\Database\Factories\BankStatementLineFactory::new();
    }
    ...
    protected $casts = [
        ...
        'amount_in_foreign_currency' => \Kezi\Foundation\Casts\OriginalCurrencyMoneyCast::class,
