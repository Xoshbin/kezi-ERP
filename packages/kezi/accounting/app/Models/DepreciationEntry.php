...
class DepreciationEntry extends Model
{
    ...
    {
        return \Kezi\Accounting\Database\Factories\DepreciationEntryFactory::new();
    }
    ...
    protected $casts = [
        ...
        'amount' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class, // Ensures precision for currency amounts
