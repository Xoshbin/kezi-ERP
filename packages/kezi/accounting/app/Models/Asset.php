...
class Asset extends Model
{
    ...
    protected $casts = [
        'purchase_date' => 'date',
        'purchase_value' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'salvage_value' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,
