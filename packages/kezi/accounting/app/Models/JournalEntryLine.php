...
class JournalEntryLine extends Model
{
    ...
    {
        return \Kezi\Accounting\Database\Factories\JournalEntryLineFactory::new();
    }
    ...
    protected $casts = [
        ...
        'debit' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'credit' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,

        // This field is in the foreign currency
        'original_currency_amount' => \Kezi\Foundation\Casts\OriginalCurrencyMoneyCast::class,
