...
use Kezi\Accounting\Database\Factories\JournalEntryFactory;
use Kezi\Accounting\Enums\Accounting\JournalEntryState;
use Kezi\Accounting\Observers\JournalEntryObserver;
use Kezi\Foundation\Casts\BaseCurrencyMoneyCast;
use Kezi\Foundation\Models\Concerns\HasDocumentAttachments;
...
class JournalEntry extends Model
{
    ...
    protected $casts = [
        'entry_date' => 'date',
        'total_debit' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
        'total_credit' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
