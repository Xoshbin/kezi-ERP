 ...
 * @mixin Eloquent
 */
#[ObservedBy([\Kezi\Accounting\Observers\AccountObserver::class, \Kezi\Foundation\Observers\AuditLogObserver::class])] // (to log when accounts are created or deprecated)
class Account extends Model
{
    use HasFactory;

    protected static function newFactory(): \Kezi\Accounting\Database\Factories\AccountFactory
    {
        return \Kezi\Accounting\Database\Factories\AccountFactory::new();
    }
    ...
    protected $casts = [
        ...
        'type' => \Kezi\Accounting\Enums\Accounting\AccountType::class, // Enums provide type safety and clarity [12]
    ];
    ...
    */
     ...
     */
    public function getRootTypeAttribute(): \Kezi\Accounting\Enums\Accounting\RootAccountType
    {
