...
class AnalyticAccount extends Model
{
    ...
    protected static function newFactory(): \Kezi\Accounting\Database\Factories\AnalyticAccountFactory
    {
        return \Kezi\Accounting\Database\Factories\AnalyticAccountFactory::new();
    }
