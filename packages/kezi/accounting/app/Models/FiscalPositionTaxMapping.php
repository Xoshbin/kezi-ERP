 ...
 *
 * @method static Builder<static>|FiscalPositionTaxMapping whereCompanyId($value)
 * @method static \Kezi\Accounting\Database\Factories\FiscalPositionTaxMappingFactory factory($count = null, $state = [])
 *
 * @mixin Eloquent
 */
class FiscalPositionTaxMapping extends Model
{
    ...
    protected static function newFactory(): \Kezi\Accounting\Database\Factories\FiscalPositionTaxMappingFactory
    {
        return \Kezi\Accounting\Database\Factories\FiscalPositionTaxMappingFactory::new();
    }
