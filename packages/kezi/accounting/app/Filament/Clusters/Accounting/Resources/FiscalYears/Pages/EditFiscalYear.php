        ...
        return Action::make('generateOpeningEntry')
            ...
            ->action(function () {
                try {
                    ...
                    $dto = new \Kezi\Accounting\DataTransferObjects\Accounting\CreateOpeningBalanceEntryDTO(
                        newFiscalYear: $currentYear,
                        previousFiscalYear: $previousYear,
                        createdByUserId: auth()->id(),
                    );

                    $entry = app(\Kezi\Accounting\Actions\Accounting\CreateOpeningBalanceEntryAction::class)->execute($dto);
                    ...
                    $this->redirect(\Kezi\Accounting\Filament\Clusters\Accounting\Resources\JournalEntries\JournalEntryResource::getUrl('edit', ['record' => $entry]));
