...
namespace Kezi\Accounting\Filament\Clusters\Accounting\Resources\WithholdingTax;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('rate')
                    ->label(__('accounting::withholding_tax.rate'))
                    ->formatStateUsing(fn ($state) => \Kezi\Foundation\Support\NumberFormatter::formatPercentage($state * 100))
                    ->sortable(),
