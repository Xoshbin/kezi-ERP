...
use Kezi\Accounting\Filament\Clusters\Accounting\Resources\CurrencyRevaluationResource\Pages;
        ...
        return $table
            ->columns([
                ...
                \Filament\Tables\Columns\TextColumn::make('status')
                    ...
                    ->badge()
                    ->color(fn (\Kezi\Accounting\Enums\Currency\RevaluationStatus $state): string => $state->color())
                    ->formatStateUsing(fn (\Kezi\Accounting\Enums\Currency\RevaluationStatus $state): string => $state->label()),
