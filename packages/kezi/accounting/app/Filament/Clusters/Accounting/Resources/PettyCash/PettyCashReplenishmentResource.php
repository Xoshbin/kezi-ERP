...
use Kezi\Accounting\Filament\Clusters\Accounting\Resources\PettyCash\PettyCashReplenishmentResource\Pages;
                    ...
                    ->schema([
                        Select::make('fund_id')
                            ...
                            ->afterStateUpdated(function ($state, callable $set) {
                                if ($state) {
                                    $fund = \Kezi\Payment\Models\PettyCash\PettyCashFund::find($state);
                                    if ($fund) {
