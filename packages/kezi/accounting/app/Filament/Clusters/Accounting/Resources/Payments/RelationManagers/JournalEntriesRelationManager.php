            ...
            ->columns([
                ...
                TextColumn::make('source_type')
                    ...
                    ->color(fn (?string $state): string => match ($state) {
                        'Kezi\Accounting\Models\Payment' => 'primary',
                        'Kezi\Accounting\Models\BankStatementLine' => 'warning',
                        'Kezi\Accounting\Models\Invoice' => 'info',
                        'Kezi\Accounting\Models\VendorBill' => 'secondary',
                        default => 'gray',
                    })
                    ->toggleable(),
