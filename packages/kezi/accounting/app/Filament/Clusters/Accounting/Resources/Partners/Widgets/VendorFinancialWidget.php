...
namespace Kezi\Accounting\Filament\Clusters\Accounting\Resources\Partners\Widgets;
...
class VendorFinancialWidget extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        if (! in_array($partner->type, [\Kezi\Foundation\Enums\Partners\PartnerType::Vendor, \Kezi\Foundation\Enums\Partners\PartnerType::Both])) {
            return [];
        }
