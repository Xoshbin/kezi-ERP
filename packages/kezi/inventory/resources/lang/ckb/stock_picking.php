...
return [
    ...
    'notifications' => [
        ...
        'confirmed' => 'پەسەندکردنی هەڵبژاردن',
        'confirmed_body' => 'هەڵبژاردنەکە بە سەرکەوتوویی پەسەندکرا. هەموو جوڵەکانی کۆگا ئێستا پەسەندکراون.',
        'cancelled' => 'هەڵوەشاندنەوەی هەڵبژاردن',
        'cancelled_body' => 'هەڵبژاردنەکە بە سەرکەوتوویی هەڵوەشایەوە. هەموو پارێزراوەکان ئازادکران.',
        'confirm_description' => 'ئایا دڵنیایت لە پەسەندکردنی ئەم هەڵبژاردنە؟ ئەمە هەموو جوڵە بەیەکەوەبەستراوەکان پەسەند دەکات.',
        'cancel_description' => 'ئایا دڵنیایت لە هەڵوەشاندنەوەی ئەم هەڵبژاردنە؟ ئەمە هەموو جوڵە بەیەکەوەبەستراوەکان هەڵدەوشێنێتەوە و پارێزراوەکان ئازاد دەکات.',
        'failed_to_confirm' => 'سەرکەوتوو نەبوو لە پەسەندکردنی هەڵبژاردن: :error',
        'failed_to_cancel' => 'سەرکەوتوو نەبوو لە هەڵوەشاندنەوەی هەڵبژاردن: :error',
    ],
];
