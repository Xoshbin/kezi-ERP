<x-filament-panels::page>
    <div class="space-y-6">
        ...
        @livewire(\Kezi\Inventory\Filament\Clusters\Inventory\Widgets\InventoryStatsOverviewWidget::class)

        {{-- Charts Grid - 2 Column Layout --}}
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            {{-- Inventory Value Chart - Spans both columns on large screens --}}
            <div class="lg:col-span-2">
                @livewire(\Kezi\Inventory\Filament\Clusters\Inventory\Widgets\InventoryValueChartWidget::class)
            </div>

            {{-- Turnover and Aging Charts - Side by Side --}}
            <div>
                @livewire(\Kezi\Inventory\Filament\Clusters\Inventory\Widgets\InventoryTurnoverChartWidget::class)
            </div>
            <div>
                @livewire(\Kezi\Inventory\Filament\Clusters\Inventory\Widgets\InventoryAgingChartWidget::class)
            </div>
        </div>
            ...
            <x-filament::card>
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <x-filament::button
                            tag="a"
                            href="{{ route('filament.kezi.inventory.resources.stock-moves.create', ['tenant' => filament()->getTenant(), 'type' => 'incoming']) }}"
                            size="sm"
                            class="mt-2"
                        >
            ...
            <x-filament::card>
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <x-filament::button
                            tag="a"
                            href="{{ route('filament.kezi.inventory.resources.stock-moves.create', ['tenant' => filament()->getTenant(), 'type' => 'outgoing']) }}"
                            size="sm"
                            class="mt-2"
                            color="warning"
                        >
            ...
            <x-filament::card>
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <x-filament::button
                            tag="a"
                            href="{{ route('filament.kezi.inventory.pages.inventory-valuation-report', ['tenant' => filament()->getTenant()]) }}"
                            size="sm"
                            class="mt-2"
                            color="success"
                        >
