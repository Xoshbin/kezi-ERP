...
namespace Kezi\Inventory\Rules\Inventory;
...
class ValidInventoryMovementRule implements ValidationRule
{
     ...
     */
    public static function incoming(\Kezi\Product\Models\Product $product, float $quantity): self
    {
     ...
     */
    public static function outgoing(\Kezi\Product\Models\Product $product, float $quantity): self
    {
