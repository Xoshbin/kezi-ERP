...
namespace Kezi\Inventory\Actions\GoodsReceipt;
...
use Kezi\Inventory\Events\GoodsReceiptValidated;
...
class ValidateGoodsReceiptAction
{
     ...
     *
     * @param  array<\Kezi\Inventory\DataTransferObjects\ReceiveGoodsLineDTO>  $lines
     */
    private function findLineDtoForProductLine(array $lines, StockMoveProductLine $productLine): ?\Kezi\Inventory\DataTransferObjects\ReceiveGoodsLineDTO
    {
