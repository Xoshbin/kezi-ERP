...
class ProcessIncomingStockAction
{
    ...
    private function processProductLine(StockMove $stockMove, StockMoveProductLine $productLine): void
    {
        ...
        if ($sourceDocument instanceof VendorBill || $sourceDocument instanceof \Kezi\Purchase\Models\PurchaseOrderLine) {
            ...
            } elseif ($sourceDocument instanceof \Kezi\Purchase\Models\PurchaseOrderLine) {
     ...
     */
    private function extractCostFromPurchaseOrderLine(StockMoveProductLine $productLine, \Kezi\Purchase\Models\PurchaseOrderLine $poLine): Money
    {
