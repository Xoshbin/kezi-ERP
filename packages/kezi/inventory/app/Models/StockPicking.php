...
class StockPicking extends Model
{
    ...
    public function hasPendingQualityChecks(): bool
    {
        return $this->qualityChecks()
            ->whereIn('status', [
                \Kezi\QualityControl\Enums\QualityCheckStatus::Draft,
                \Kezi\QualityControl\Enums\QualityCheckStatus::InProgress,
            ])
            ->exists();
    }
    ...
    protected static function newFactory(): \Kezi\Inventory\Database\Factories\StockPickingFactory
    {
        return \Kezi\Inventory\Database\Factories\StockPickingFactory::new();
    }
}
