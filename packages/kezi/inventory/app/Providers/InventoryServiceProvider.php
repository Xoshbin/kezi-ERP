...
class InventoryServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            \Kezi\Inventory\Console\Commands\RunReorderingSchedulerCommand::class,
            // \Kezi\Inventory\Console\Commands\InventoryPerformanceAnalysis::class, // optional
        ]);
    }
    ...
    public function registerViews(): void
    {
        ...
        Blade::componentNamespace('Kezi\\Inventory\\View\\Components', $this->nameLower);
    }
