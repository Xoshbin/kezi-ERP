...
{
    protected $model = \Kezi\Inventory\Models\AdjustmentDocument::class;
    ...
    {
        return $this->afterCreating(function (\Kezi\Inventory\Models\AdjustmentDocument $adjustmentDocument) use ($count) {
