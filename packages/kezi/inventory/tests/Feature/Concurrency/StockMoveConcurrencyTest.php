...
namespace Kezi\Inventory\Tests\Feature\Concurrency;
...
try {
    \$service = app(\Kezi\Inventory\Services\Inventory\StockMoveService::class);
            ...
            try {
                \Illuminate\Support\Facades\DB::transaction(function() use (\$service) {
                    \$dto = new \Kezi\Inventory\DataTransferObjects\Inventory\CreateStockMoveDTO(
                        ...
                        product_lines: [
                            new \Kezi\Inventory\DataTransferObjects\Inventory\CreateStockMoveProductLineDTO(
