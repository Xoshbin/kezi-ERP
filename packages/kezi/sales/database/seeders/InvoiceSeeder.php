...
namespace Kezi\Sales\Database\Seeders;
...
class InvoiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // --- Fetch Partners ---
        $hawrePartner = Partner::firstOrCreate(['name' => 'Hawre Trading Group', 'company_id' => $company->id], ['type' => \Kezi\Foundation\Enums\Partners\PartnerType::Customer]);
        $zryanPartner = Partner::firstOrCreate(['name' => 'Zryan Tech Store', 'company_id' => $company->id], ['type' => \Kezi\Foundation\Enums\Partners\PartnerType::Customer]);
