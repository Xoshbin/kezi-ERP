...
namespace Kezi\Sales\Tests\Feature;
...
class InvoiceNumberRaceConditionTest extends TestCase
{
    ...
    public function it_generates_unique_invoice_numbers_without_race_conditions()
    {
        ...
        for ($i = 0; $i < 3; $i++) {
            ...
            $invoices[] = app(\Kezi\Sales\Actions\Sales\CreateInvoiceAction::class)->execute($invoiceDTO);
        }
    ...
    private function createTestInvoice(): Invoice
    {
        ...
        return app(\Kezi\Sales\Actions\Sales\CreateInvoiceAction::class)->execute($invoiceDTO);
    }
}
