...
it('convert quote to invoice success', function () {
    ...
    $incomeAccount = \Kezi\Accounting\Models\Account::factory()->create(['company_id' => $this->company->id]);

    QuoteLine::factory()->create([
        'quote_id' => $quote->id,
        'product_id' => \Kezi\Product\Models\Product::factory()->create(['company_id' => $this->company->id])->id,
        'quantity' => 1,
