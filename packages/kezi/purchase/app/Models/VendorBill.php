...
use Kezi\Purchase\Database\Factories\VendorBillFactory;
use Kezi\Purchase\Enums\Purchases\ThreeWayMatchStatus;
use Kezi\Purchase\Enums\Purchases\VendorBillStatus;
use Kezi\Purchase\Observers\VendorBillObserver;
...
class VendorBill extends Model
{
    ...
    {
        return \Kezi\Purchase\Database\Factories\VendorBillFactory::new();
    }
    ...
    protected $casts = [
        ...
        'total_amount' => \Kezi\Foundation\Casts\DocumentCurrencyMoneyCast::class,  // Document currency amounts
        'total_tax' => \Kezi\Foundation\Casts\DocumentCurrencyMoneyCast::class,  // Document currency amounts
        'total_amount_company_currency' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,  // Company base currency amounts
        'total_tax_company_currency' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,  // Company base currency amounts
