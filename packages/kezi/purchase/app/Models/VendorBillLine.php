...
use Kezi\Purchase\Database\Factories\VendorBillLineFactory;
use Kezi\Purchase\Observers\VendorBillLineObserver;
...
class VendorBillLine extends Model
{
    ...
    {
        return \Kezi\Purchase\Database\Factories\VendorBillLineFactory::new();
    }
    ...
    protected $casts = [
        ...
        'unit_price' => \Kezi\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Document currency amounts
        'unit_price_company_currency' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
        'shipping_cost_type' => ShippingCostType::class,
        'subtotal' => \Kezi\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Document currency amounts
        'subtotal_company_currency' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
        'total_line_tax' => \Kezi\Foundation\Casts\DocumentCurrencyMoneyCast::class, // Document currency amounts
        'total_line_tax_company_currency' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class, // Company base currency amounts
