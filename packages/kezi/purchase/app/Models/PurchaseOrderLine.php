...
class PurchaseOrderLine extends Model
{
    ...
    protected $casts = [
        ...
        'total' => \Kezi\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        ...
        'total_company_currency' => \Kezi\Foundation\Casts\BaseCurrencyMoneyCast::class,
    ...
    protected static function newFactory(): \Kezi\Purchase\Database\Factories\PurchaseOrderLineFactory
    {
        return \Kezi\Purchase\Database\Factories\PurchaseOrderLineFactory::new();
    }
}
