...
namespace Kezi\Purchase\Filament\Clusters\Purchases\Resources\RequestForQuotations\Tables;
        ...
        return $table
            ...
            ->actions([
                \Filament\Actions\ViewAction::make()
                    ->url(fn (\Kezi\Purchase\Models\RequestForQuotation $record): string => \Kezi\Purchase\Filament\Clusters\Purchases\Resources\RequestForQuotations\RequestForQuotationResource::getUrl('view', ['record' => $record])),
                \Filament\Actions\EditAction::make()
                    ->url(fn (\Kezi\Purchase\Models\RequestForQuotation $record): string => \Kezi\Purchase\Filament\Clusters\Purchases\Resources\RequestForQuotations\RequestForQuotationResource::getUrl('edit', ['record' => $record])),
            ])
            ->bulkActions([
