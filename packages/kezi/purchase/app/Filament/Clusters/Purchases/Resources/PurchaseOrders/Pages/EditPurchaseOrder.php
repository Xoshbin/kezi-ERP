...
class EditPurchaseOrder extends EditRecord
{
            ...
            Action::make('confirm')
                ...
                ->action(function () {
                    try {
                        ...
                        $this->refreshFormData(['status']);
                    } catch (\Kezi\Accounting\Exceptions\BudgetExceededException $e) {
                        Notification::make()
                            ->title($e->getMessage())
                            ->danger()
                            ->send();
    ...
    protected function handleRecordUpdate(\Illuminate\Database\Eloquent\Model $record, array $data): \Illuminate\Database\Eloquent\Model
    {
        ...
        $dto = new UpdatePurchaseOrderDTO(
            ...
            incoterm: isset($data['incoterm']) ? ($data['incoterm'] instanceof Incoterm ? $data['incoterm'] : Incoterm::tryFrom($data['incoterm'])) : null,
            status: isset($data['status']) ? ($data['status'] instanceof PurchaseOrderStatus ? $data['status'] : PurchaseOrderStatus::tryFrom($data['status'])) : null,
        );
