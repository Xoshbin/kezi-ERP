    ...
    private function transformPurchaseOrderToVendorBillDTO(
        ...
        foreach ($purchaseOrder->lines as $poLine) {
            ...
            if ($poLine->product_id && $poLine->product) {
                if ($poLine->product->type === \Kezi\Product\Enums\Products\ProductType::Storable) {
            ...
            if (! $expenseAccountId) {
                ...
                $accountTypeNeeded = ($poLine->product?->type === \Kezi\Product\Enums\Products\ProductType::Storable)
                    ? 'Stock Input Account'
                    : 'Expense Account';
