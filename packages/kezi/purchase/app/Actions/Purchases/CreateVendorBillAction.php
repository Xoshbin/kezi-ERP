...
class CreateVendorBillAction
{
    public function __construct(
        ...
        protected \Kezi\Accounting\Services\Accounting\FiscalPositionService $fiscalPositionService,
    ) {}
    ...
    public function execute(CreateVendorBillDTO $createVendorBillDTO): VendorBill
    {
        ...
        return DB::transaction(function () use ($createVendorBillDTO) {
            ...
            if (! $fiscalPositionId) {
                $vendor = \Kezi\Foundation\Models\Partner::findOrFail($createVendorBillDTO->vendor_id);
            ...
            $vendorBill = VendorBill::create([
                ...
                'incoterm_location' => $createVendorBillDTO->incoterm_location,
                'exchange_rate_at_creation' => $createVendorBillDTO->exchange_rate_at_creation,
