...
{
    protected $model = \Kezi\Purchase\Models\VendorBill::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'total_amount' => function (array $attributes) {
                $currencyCode = \Kezi\Foundation\Models\Currency::find($attributes['currency_id'])->code;
    ...
    {
        return $this->afterCreating(function (\Kezi\Purchase\Models\VendorBill $vendorBill) use ($count) {
