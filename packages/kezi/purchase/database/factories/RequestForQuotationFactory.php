...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Kezi\Purchase\Models\RequestForQuotation>
 */
class RequestForQuotationFactory extends Factory
{
    protected $model = \Kezi\Purchase\Models\RequestForQuotation::class;

    public function definition(): array
    {
        return [
            'company_id' => \App\Models\Company::factory(),
            'vendor_id' => \Kezi\Foundation\Models\Partner::factory()->vendor(),
            ...
            'exchange_rate' => 1,
            'status' => \Kezi\Purchase\Enums\Purchases\RequestForQuotationStatus::Draft,
