...
use Modules\Accounting\Services\Reports\Consolidation\ConsolidatedBalanceSheetService;
...
beforeEach(function () {
    ...
    $parent = Company::factory()->create([
        'name' => 'Parent Corp',
        'currency_id' => $usd->id,
        'consolidation_method' => \Modules\Accounting\Enums\Consolidation\ConsolidationMethod::Full,
    ]);
    $this->parent = $parent;
...
test('it generates consolidated balance sheet with elimination', function () {
    ...
    /** @var \Modules\Accounting\DataTransferObjects\Reports\ReportLineDTO $cashLine */
    ...
    /** @var \Modules\Accounting\DataTransferObjects\Reports\ReportLineDTO $loanRecLine */
    ...
    /** @var \Modules\Accounting\DataTransferObjects\Reports\ReportLineDTO $loanPayLine */
