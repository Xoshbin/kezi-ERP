...
class AssetService
{
    ...
    public function computeDepreciation(Asset $asset): Collection
    {
        ...
        return match ($asset->depreciation_method) {
            \Modules\Accounting\Enums\Assets\DepreciationMethod::Declining => $this->computeDecliningBalance($asset),
            \Modules\Accounting\Enums\Assets\DepreciationMethod::SumOfDigits => $this->computeSumOfDigits($asset),
