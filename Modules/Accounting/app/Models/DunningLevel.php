...
class DunningLevel extends Model
{
    ...
    protected static function newFactory(): \Modules\Accounting\Database\Factories\DunningLevelFactory
    {
        return \Modules\Accounting\Database\Factories\DunningLevelFactory::new();
    }
