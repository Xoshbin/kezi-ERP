...
test('it generates correct accounting lines with balanced debits and credits', function () {
    ...
    $salaryExpenseAccount = \Modules\Accounting\Models\Account::factory()->create(['company_id' => $this->company->id]);
    $salaryPayableAccount = \Modules\Accounting\Models\Account::factory()->create(['company_id' => $this->company->id]);
