...
namespace Modules\HR\Actions\EmploymentContracts;

use Illuminate\Support\Facades\DB;
use Modules\HR\DataTransferObjects\EmploymentContracts\EmploymentContractDTO;
use Modules\HR\Models\EmploymentContract;

class UpdateEmploymentContractAction
{
    public function execute(EmploymentContract $contract, EmploymentContractDTO $dto): EmploymentContract
    {
