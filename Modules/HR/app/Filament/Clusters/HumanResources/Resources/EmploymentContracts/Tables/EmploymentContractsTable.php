...
namespace Modules\HR\Filament\Clusters\HumanResources\Resources\EmploymentContracts\Tables;
...
class EmploymentContractsTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->headerActions([
                CreateAction::make()
                    ->using(function (array $data): \Modules\HR\Models\EmploymentContract {
            ...
            ->actions([
                EditAction::make()
                    ->using(function (\Modules\HR\Models\EmploymentContract $record, array $data): \Modules\HR\Models\EmploymentContract {
