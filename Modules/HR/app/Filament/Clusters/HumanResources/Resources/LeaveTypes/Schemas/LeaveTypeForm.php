...
namespace Modules\HR\Filament\Clusters\HumanResources\Resources\LeaveTypes\Schemas;
...
class LeaveTypeForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Section::make(__('hr::leave_type.basic_information'))
                ->description(__('hr::leave_type.basic_information_description'))
                ->schema([
                    TextInput::make('name')
                    ...
                    Textarea::make('description')
                        ->label(__('hr::leave_type.description'))
                        ->maxLength(1000)
                        ->rows(3)
                        ->columnSpanFull(),
            ...
            Section::make(__('hr::leave_type.allocation_rules'))
                ->description(__('hr::leave_type.allocation_rules_description'))
                ->schema([
            ...
            Section::make(__('hr::leave_type.approval_rules'))
                ->description(__('hr::leave_type.approval_rules_description'))
                ->schema([
            ...
            Section::make(__('hr::leave_type.payment_status'))
                ->description(__('hr::leave_type.payment_status_description'))
                ->schema([
                    Toggle::make('is_paid')
