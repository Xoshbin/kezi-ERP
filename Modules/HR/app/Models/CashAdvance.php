...
class CashAdvance extends Model
{
    ...
    protected $casts = [
        'requested_amount' => \Modules\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'approved_amount' => \Modules\Foundation\Casts\BaseCurrencyMoneyCast::class,
        'disbursed_amount' => \Modules\Foundation\Casts\BaseCurrencyMoneyCast::class,
    ...
    {
        return \Modules\HR\Database\Factories\CashAdvanceFactory::new();
    }
}
