...
describe('PurchaseOrder Filament Create Bill Action', function () {
    ...
    it('hides the create bill action when PO has bills and canCreateBill logic prevents it', function () {
        ...
        app(\Modules\Purchase\Actions\Purchases\CreateVendorBillFromPurchaseOrderAction::class)->execute(
            new \Modules\Purchase\DataTransferObjects\Purchases\CreateVendorBillFromPurchaseOrderDTO(
                purchase_order_id: $po->id,
