...
namespace Modules\Purchase\Tests\Feature\Actions;
...
use Modules\Purchase\Actions\Purchases\CreateDebitNoteAction;
use Modules\Purchase\DataTransferObjects\Purchases\CreateDebitNoteDTO;
use Modules\Purchase\DataTransferObjects\Purchases\CreateDebitNoteLineDTO;
...
beforeEach(function () {
    ...
    // Vendor
    $this->vendor = \Modules\Foundation\Models\Partner::factory()->for($this->company)->create(['type' => 'vendor']);
