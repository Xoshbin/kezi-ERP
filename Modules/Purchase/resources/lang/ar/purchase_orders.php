...
return [
    ...
    'actions' => [
        ...
        'ready_to_receive_confirmation_title' => 'جاهز لاستلام البضائع',
        'ready_to_receive_confirmation_description' => 'سيتم تحديد أمر الشراء كجاهز لاستلام البضائع من المورد.',
        'mark_done' => 'تحديد كمكتمل',
        'cancel' => 'إلغاء أمر الشراء',
        'receive_goods' => 'استلام البضائع',
        'create_bill' => 'إنشاء فاتورة مورد',
        'create_bill_confirmation_title' => 'إنشاء فاتورة مورد',
        'create_bill_confirmation_description' => 'سيتم إنشاء فاتورة مورد تلقائياً مع جميع بنود هذا أمر الشراء. ستكون الفاتورة في حالة مسودة للمراجعة.',
        'add_line' => 'إضافة بند',
    ...
    'notifications' => [
        ...
        'confirmed' => 'تم تأكيد أمر الشراء بنجاح.',
        'ready_to_receive' => 'أمر الشراء جاهز الآن لاستلام البضائع.',
    ...
    'help' => [
        ...
        'status_cannot_create_bill' => 'غيّر الحالة إلى مؤكد أو في انتظار الاستلام أو لاحقاً لتمكين إنشاء الفاتورة.',
        'status_bills_already_exist' => 'توجد فواتير مورد بالفعل لأمر الشراء هذا.',
        'status_forward_only' => 'يمكن تغيير الحالة للأمام فقط في سير العمل.',
    ],
