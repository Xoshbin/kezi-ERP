...
class InventoryQualityGateTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $move = StockMove::create([
            ...
            'status' => \Modules\Inventory\Enums\Inventory\StockMoveStatus::Confirmed,
    ...
    private function validatePicking(): void
    {
        ...
        app(\Modules\Inventory\Actions\Inventory\ValidateStockPickingAction::class)->execute($this->picking, $data, false);
    }
}
