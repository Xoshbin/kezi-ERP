...
use Modules\QualityControl\Actions\ResolveQualityAlertAction;
...
class QualityAlertResolutionTest extends TestCase
{
    ...
    public function test_triggers_scrap_action_when_resolving_with_scrap(): void
    {
        ...
        $scrapAccount = \Modules\Accounting\Models\Account::factory()->create([
            'company_id' => $this->company->id,
            'type' => 'expense',
        ]);
        ...
        $product = Product::factory()->create([
            ...
            'default_cogs_account_id' => \Modules\Accounting\Models\Account::factory()->create(['company_id' => $this->company->id, 'type' => 'expense'])->id,
        ]);
