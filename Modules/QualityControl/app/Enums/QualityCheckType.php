...
enum QualityCheckType: string
{
    ...
    {
        return match ($this) {
            self::PassFail => __('quality::enums.check_type.pass_fail'),
            self::Measure => __('quality::enums.check_type.measure'),
            self::TextInput => __('quality::enums.check_type.text_input'),
            self::TakePhoto => __('quality::enums.check_type.take_photo'),
            self::Instructions => __('quality::enums.check_type.instructions'),
        };
    }
