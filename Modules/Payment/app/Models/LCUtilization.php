...
class LCUtilization extends Model
{
    ...
    protected $casts = [
        'utilized_amount' => \Modules\Foundation\Casts\DocumentCurrencyMoneyCast::class,
        'utilized_amount_company_currency' => \Modules\Foundation\Casts\BaseCurrencyMoneyCast::class,
    ...
    {
        return \Modules\Payment\Database\Factories\LCUtilizationFactory::new();
    }
}
