 ...
 */
#[ObservedBy([
    \Modules\Foundation\Observers\AuditLogObserver::class,
    \Modules\ProjectManagement\Observers\TimesheetLineObserver::class,
])]
class TimesheetLine extends Model
{
    ...
    {
        return \Modules\ProjectManagement\Database\Factories\TimesheetLineFactory::new();
    }
}
