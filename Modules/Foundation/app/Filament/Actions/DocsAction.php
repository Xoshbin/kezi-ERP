...
class DocsAction
{
    ...
    private static function mapSlugToDocumentationPath(string $slug): string
    {
        $mapping = [
            ...
            'bill-of-materials' => 'User Guide/bill-of-materials',
            'manufacturing-orders' => 'User Guide/manufacturing-orders',
            'project-management' => 'User Guide/project-management',
            'project-budgeting' => 'User Guide/project-budgeting',
            'timesheet-tracking' => 'User Guide/timesheet-tracking',
            'lot-tracking' => 'User Guide/lot-tracking',
            'serial-number-tracking' => 'User Guide/serial-number-tracking',
            'inter-warehouse-transfers' => 'User Guide/inter-warehouse-transfers',
            'stock-movements' => 'User Guide/stock-movements',
            'reordering-rules' => 'User Guide/reordering-rules',
            'inventory-management' => 'User Guide/inventory-management',
            'understanding-fiscal-years' => 'User Guide/understanding-fiscal-years',
            'understanding-cash-advances' => 'User Guide/understanding-cash-advances',
            'understanding-petty-cash' => 'User Guide/understanding-petty-cash',
            'incoterms' => 'User Guide/incoterms',
