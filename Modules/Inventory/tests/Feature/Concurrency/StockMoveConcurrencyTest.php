...
namespace Modules\Inventory\Tests\Feature\Concurrency;
...
try {
    \$service = app(\Modules\Inventory\Services\Inventory\StockMoveService::class);
            ...
            try {
                \Illuminate\Support\Facades\DB::transaction(function() use (\$service) {
                    \$dto = new \Modules\Inventory\DataTransferObjects\Inventory\CreateStockMoveDTO(
                        ...
                        product_lines: [
                            new \Modules\Inventory\DataTransferObjects\Inventory\CreateStockMoveProductLineDTO(
