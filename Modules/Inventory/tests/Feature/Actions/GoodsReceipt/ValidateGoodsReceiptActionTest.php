...
namespace Modules\Inventory\Tests\Feature\Actions\GoodsReceipt;
...
it('validates a goods receipt successfully', function () {
    ...
    $po = PurchaseOrder::factory()->create([
        ...
        'vendor_id' => \Modules\Foundation\Models\Partner::factory()->create(['company_id' => $this->company->id])->id,
    ]);
