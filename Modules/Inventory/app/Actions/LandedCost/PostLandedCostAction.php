        ...
        DB::transaction(function () use ($landedCost) {
            ...
            foreach ($landedCost->lines as $line) {
                ...
                if (in_array($valuationMethod, [ValuationMethod::FIFO, ValuationMethod::LIFO])) {
                    ...
                    /** @var \Illuminate\Database\Eloquent\Collection<int, \Modules\Inventory\Models\InventoryCostLayer> $layers */
                    $layers = \Modules\Inventory\Models\InventoryCostLayer::query()
                        ->where('source_type', \Modules\Inventory\Models\StockMove::class)
