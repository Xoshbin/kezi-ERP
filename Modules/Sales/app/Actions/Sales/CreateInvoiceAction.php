...
class CreateInvoiceAction
{
    public function __construct(
        ...
        private readonly \Modules\Accounting\Services\Accounting\FiscalPositionService $fiscalPositionService,
    ) {}
    ...
    public function execute(CreateInvoiceDTO $dto): Invoice
    {
        ...
        $invoice = DB::transaction(function () use ($dto) {
            ...
            if (! $fiscalPositionId) {
                $customer = \Modules\Foundation\Models\Partner::findOrFail($dto->customer_id);
