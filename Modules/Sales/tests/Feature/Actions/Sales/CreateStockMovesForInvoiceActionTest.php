...
it('creates stock moves for storable products on invoice', function () {
    // Setup Locations
    $warehouse = StockLocation::factory()->create(['company_id' => $this->company->id, 'type' => \Modules\Inventory\Enums\Inventory\StockLocationType::Internal, 'name' => 'Warehouse']);
    $customerLoc = StockLocation::factory()->create(['company_id' => $this->company->id, 'type' => \Modules\Inventory\Enums\Inventory\StockLocationType::Customer, 'name' => 'Customers']);
