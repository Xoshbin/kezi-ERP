...
it('can create an invoice from a confirmed sales order', function () {
    $currency = \Modules\Foundation\Models\Currency::where('code', 'USD')->first() ?? \Modules\Foundation\Models\Currency::factory()->create(['code' => 'USD']);

    $customer = \Modules\Foundation\Models\Partner::factory()->create([
    ...
    expect($invoice)->toBeInstanceOf(\Modules\Sales\Models\Invoice::class)
