        ...
        (function (h, a) {
            ...
            return (function (l) {
                ...
                var sn = (function () {
                        ...
                        urls: en, handlesActivityChecks: !1, supportsPing: !0, isInitialized: function () {
                            return !0
                        }
                    }, Bt = U({
                        getSocket: function (e) {
                    ...
                    }, fn = new tt(U({}, Bt, Jt)), pn = new tt(U({}, Xt, Jt)),
                    dn = {ws: ln, xhr_streaming: fn, xhr_polling: pn}, ht = dn, vn = new tt({
                        file: "sockjs",
                        urls: nn,
                ...
                var pr = function (e, t, n) {
                    ...
                    var o = Object.assign({}, t, {
                        ...
                        E = i("ws", "ws", 3, o, g), X = i("wss", "ws", 3, u, g), vi = i("sockjs", "sockjs", 1, p),
                        ne = i("xhr_streaming", "xhr_streaming", 1, p, k),
                        yi = i("xdr_streaming", "xdr_streaming", 1, p, k), re = i("xhr_polling", "xhr_polling", 1, p),
                        gi = i("xdr_polling", "xdr_polling", 1, p), ie = new Y([E], _), _i = new Y([X], _),
                        bi = new Y([vi], _), oe = new Y([new it(ot(ne), ne, yi)], _),
